...
type JoinRoundRequest struct {
	...
	// batch_slot explicitly selects a scheduled registration opportunity.
	// Absence requests legacy event-driven timing. It is bound by join auth.
	BatchSlot     *BatchSlot `protobuf:"bytes,8,opt,name=batch_slot,json=batchSlot,proto3" json:"batch_slot,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *JoinRoundRequest) GetBatchSlot() *BatchSlot {
	if x != nil {
		return x.BatchSlot
	}
	return nil
...
// BatchSlot binds a join to one timetable and cutoff.
type BatchSlot struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// schedule_id is the 32-byte timing-policy identifier from discovery.
	ScheduleId []byte `protobuf:"bytes,1,opt,name=schedule_id,json=scheduleId,proto3" json:"schedule_id,omitempty"`
	// cutoff_unix is the positive Unix second at which registration closes.
...
func (x *BatchSlot) GetScheduleId() []byte {
	if x != nil {
		return x.ScheduleId
	}
	return nil
...
func (x *BatchSlot) GetCutoffUnix() uint64 {
	if x != nil {
		return x.CutoffUnix
	}
	return 0
...
const file_round_proto_rawDesc = "" +
	...
	"\n" +
	"batch_slot\x18\b \x01(\v2\x13.round.v1.BatchSlotR\tbatchSlot\"M\n" +
	"\tBatchSlot\x12\x1f\n" +
...
var file_round_proto_goTypes = []any{
	...
	(*BatchSlot)(nil),                    // 23: round.v1.BatchSlot
...
var file_round_proto_depIdxs = []int32{
	...
	23, // 25: round.v1.JoinRoundRequest.batch_slot:type_name -> round.v1.BatchSlot
