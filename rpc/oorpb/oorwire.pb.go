...
type SubmitPackageSuccess struct {
	...
	// co_signed_ark_psbt is the serialized Ark PSBT after the operator has
	// attached its checkpoint-collab signatures. Recipients persist this exact
	// artifact for chained recovery/unroll.
