...
// corrupted persisted blob cannot force multi-GB allocations.
...
// encodeListSessionsPayload encodes the list-sessions query filters.
...
// decodeListSessionsPayload decodes the list-sessions query filters.
...
func encodeDriveEventRequestPayload(sessionID SessionID,
	...
	// transport layer with nil ArkPSBT, which the actor enriches from
