...
// collabLeafScript returns the raw collab leaf script bytes for a 2-of-2
// CHECKSIGVERIFY multisig between ownerKey and cosignerKey.
func collabLeafScript(ownerKey,
	cosignerKey *btcec.PublicKey) ([]byte, error) {
