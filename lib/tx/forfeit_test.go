...
func TestValidateForfeitTx(t *testing.T) {
	...
	serverForfeitScript := testForfeitScript()
...
// testForfeitScript returns a fixed P2TR-shaped server forfeit script used as
// the penalty output across the forfeit validation tests.
func testForfeitScript() []byte {
	return []byte{
...
func TestValidateForfeitTxRoundTrip(t *testing.T) {
	...
	for _, amount := range amounts {
		t.Run(amount.String(), func(t *testing.T) {
			...
			serverScript := testForfeitScript()
