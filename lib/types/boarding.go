...
type OperatorTerms struct {
	...
	// NextBatchCutoff is the operator cursor observed during discovery. It
	// fences local slot selection when operator wall time moves backward.
	NextBatchCutoff time.Time
