...
const (
	...
	forfeitSignatureRequestDomain       = "waved-forfeit-signature-" +
		"request-v1"
)

func unspecifiedForfeitSigningRoute() waverpc.ForfeitSigningRoute {
	return waverpc.
...
type forfeitSigningContext struct {
	paymentHash []byte
	route       waverpc.ForfeitSigningRoute
}

type forfeitSignatureRequest struct {
	proto      *waverpc.PendingForfeitParticipantSignatureRequest
...
func (b *forfeitSignatureBroker) sign(ctx context.Context,
	...
	case waverpc.ForfeitSigningRoute_FORFEIT_SIGNING_ROUTE_LOCAL_SIGNER:
		b.mu.Lock()
...
func (b *forfeitSignatureBroker) list(after uint64, limit uint32) (
	[]*waverpc.PendingForfeitParticipantSignatureRequest, uint64) {
	...
	requests := make(
		[]*waverpc.PendingForfeitParticipantSignatureRequest, 0, limit,
	)
	next := after
...
func (b *forfeitSignatureBroker) submit(requestID []byte,
	signatures []*waverpc.ForfeitParticipantSignature) error {
...
func pendingForfeitSignatureRequest(correlation forfeitSigningContext,
	req *vtxo.ForfeitParticipantSignRequest) (
	*waverpc.PendingForfeitParticipantSignatureRequest, error) {
	...
	pending := &waverpc.PendingForfeitParticipantSignatureRequest{
...
func forfeitSignatureRequestID(
	req *waverpc.PendingForfeitParticipantSignatureRequest) []byte {
...
func parseForfeitParticipantSignature(
	sig *waverpc.ForfeitParticipantSignature) (*types.ForfeitParticipantSig,
	error) {
...
func clonePendingForfeitSignatureRequest(
	req *waverpc.PendingForfeitParticipantSignatureRequest,
) *waverpc.PendingForfeitParticipantSignatureRequest {

	if req == nil {
		return nil
	}

	return &waverpc.PendingForfeitParticipantSignatureRequest{
...
func samePendingForfeitSignatureRequest(
	a, b *waverpc.PendingForfeitParticipantSignatureRequest) bool {
