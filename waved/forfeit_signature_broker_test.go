...
func localForfeitSigningRoute() waverpc.ForfeitSigningRoute {
	route := waverpc.
...
func pendingForfeitSigningRoute() waverpc.ForfeitSigningRoute {
	route := waverpc.
...
func TestForfeitSignatureBrokerSurfacesAndCompletesRequest(t *testing.T) {
	...
	var pending *waverpc.PendingForfeitParticipantSignatureRequest
...
func TestForfeitSignatureBrokerSubmitRejectsUnknownRequest(t *testing.T) {
	...
	err = broker.submit([]byte("missing"),
		[]*waverpc.ForfeitParticipantSignature{{
...
func testDaemonForfeitParticipantSignaturesForRequest(t *testing.T,
	...
	signers ...*btcec.PrivateKey) []*waverpc.ForfeitParticipantSignature {
...
func sameSubmittedParticipantSet(got []*types.ForfeitParticipantSig,
	want []*waverpc.ForfeitParticipantSignature) bool {
