...
func (r *RPCServer) ReceiveAuthECDH(ctx context.Context,
	req *waverpc.ReceiveAuthECDHRequest) (*waverpc.ReceiveAuthECDHResponse,
	error) {
...
func (r *RPCServer) GenSeed(ctx context.Context, req *waverpc.GenSeedRequest) (
	*waverpc.GenSeedResponse, error) {
	...
	return &waverpc.GenSeedResponse{
		Mnemonic: mnemonic[:],
	}, nil
}
...
func (r *RPCServer) InitWallet(ctx context.Context,
	...
	resp := &waverpc.InitWalletResponse{
...
func (r *RPCServer) UnlockWallet(ctx context.Context,
	...
	return &waverpc.UnlockWalletResponse{
		IdentityPubkey: identityPubkey,
	}, nil
}
