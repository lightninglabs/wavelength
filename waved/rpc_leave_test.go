...
func TestResolveLeaveDestinationInvalidAddress(t *testing.T) {
	...
	_, err := r.resolveLeaveDestination(&waverpc.LeaveDestination{
...
func TestResolveLeaveDestinationPkScript(t *testing.T) {
	...
	got, err := r.resolveLeaveDestination(&waverpc.LeaveDestination{
...
func TestLeaveVTXOsRejectsAllWithPerOutpointOverrides(t *testing.T) {
	...
	req := &waverpc.LeaveVTXOsRequest{
		...
		Destinations: map[string]*waverpc.LeaveDestination{
			validOutpoint(): {
				Target: &waverpc.LeaveDestination_PkScript{
