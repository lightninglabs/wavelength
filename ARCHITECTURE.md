...
| [`tapassets`](tapassets/) | Adapts tap-sdk custom-anchor transitions to Ark trees: caller-funded asset batch outputs and asset-aware VTXO tree materialization with a durable commit journal |
