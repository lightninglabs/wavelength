...
| [`tapassets`](tapassets/) | tap-sdk custom-anchor adapter: journals asset batch-output commits and materializes asset-aware VTXO trees beneath them (not yet wired into the daemon) |
...
| [`internal/expiryfixture`](internal/expiryfixture/) | Deterministic musig2-signed VTXO ancestry fixtures for acceptance-boundary tests |
