...
| [`swapclientserver`](swapclientserver/) | Optional daemon gRPC subserver (`swapruntime` tag) wrapping `sdk/swaps` with background worker management and RPC translation |
