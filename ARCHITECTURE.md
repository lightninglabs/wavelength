...
| [`tapassets`](tapassets/) | Adapts tap-sdk custom-anchor transitions to Ark trees: caller-funded asset batch outputs and asset-aware VTXO tree materialization, journaled for crash-safe replay |
...
| [`internal/expiryfixture`](internal/expiryfixture/) | Deterministic signed commitment trees and OOR ancestry packages for authenticated incoming-expiry acceptance tests |
