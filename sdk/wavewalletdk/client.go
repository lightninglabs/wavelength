...
type Client struct {
	...
	wallet wavewalletrpc.WalletServiceClient
...
// Connect returns a wavewalletdk client connected to an external daemon.
func Connect(ctx context.Context, cfg ConnectConfig) (*Client, error) {
	...
	default:
		return nil, fmt.Errorf("unknown wavewalletdk transport %q",
			cfg.Transport)
	}
}
...
// GRPCConn returns the private gRPC client connection used by wavewalletdk.
...
func (c *Client) WalletRPC() wavewalletrpc.WalletServiceClient {
	if c == nil {
		return nil
	}
...
func (c *Client) Balance(ctx context.Context) (*Balance, error) {
	...
	resp, err := c.wallet.Balance(ctx, &wavewalletrpc.BalanceRequest{})
	if err != nil {
...
func (c *Client) Deposit(ctx context.Context, req DepositRequest) (
	*DepositResult, error) {
	...
	resp, err := c.wallet.Deposit(ctx, &wavewalletrpc.DepositRequest{
...
func (c *Client) PrepareSend(ctx context.Context, req PrepareSendRequest) (
	*PrepareSendResult, error) {
	...
	case invoice != "":
		protoReq.Destination = &wavewalletrpc.
...
func (c *Client) SendPrepared(ctx context.Context, req SendPreparedRequest) (
	*SendResult, error) {
	...
	resp, err := c.wallet.Send(ctx, &wavewalletrpc.SendRequest{
...
func (c *Client) List(ctx context.Context, req ListRequest) (*ListResult,
	...
	resp, err := c.wallet.List(ctx, &wavewalletrpc.ListRequest{
		View:        protoView,
...
func (c *Client) Exit(ctx context.Context, req ExitRequest) (*ExitResult,
	...
	resp, err := c.wallet.Exit(ctx, &wavewalletrpc.ExitRequest{
...
func (c *Client) ExitStatus(ctx context.Context, req ExitStatusRequest) (
	*ExitStatusResult, error) {
	...
	resp, err := c.wallet.ExitStatus(ctx, &wavewalletrpc.ExitStatusRequest{
		Outpoint: req.Outpoint,
...
func (c *Client) GetExitPlan(ctx context.Context, req GetExitPlanRequest) (
	*GetExitPlanResult, error) {
	...
	resp, err := c.wallet.GetExitPlan(
		ctx, &wavewalletrpc.GetExitPlanRequest{
...
func (c *Client) Status(ctx context.Context) (*Status, error) {
	...
	resp, err := c.wallet.Status(ctx, &wavewalletrpc.StatusRequest{})
	if err != nil {
...
func (c *Client) Subscribe(ctx context.Context, req SubscribeRequest) (
	...
	stream, err := c.wallet.SubscribeWallet(
		ctx, &wavewalletrpc.SubscribeWalletRequest{
...
// wavewalletrpc before any RPC is attempted.
...
func newClient(conn grpc.ClientConnInterface, canWallet bool,
	...
	return newClientWithRPC(
		...
		wavewalletrpc.NewWalletServiceClient(conn), canWallet, waitCh,
		closeFn,
	)
}
...
func newClientWithRPC(conn grpc.ClientConnInterface,
	daemon waverpc.DaemonServiceClient,
	swaps swapclientrpc.SwapClientServiceClient,
	wallet wavewalletrpc.WalletServiceClient, canWallet bool,
	waitCh <-chan error, closeFn func(context.Context) error) *Client {
