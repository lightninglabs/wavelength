...
// TestReadyRequiresCompleteEvidence proves a matching generation marker cannot
// accidentally admit an upgrade placeholder or partially corrupt row.
func TestReadyRequiresCompleteEvidence(t *testing.T) {
	t.Parallel()
