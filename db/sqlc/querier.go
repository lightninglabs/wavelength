...
type Querier interface {
	...
	GetOORIncomingSession(ctx context.Context, sessionID []byte) (OorIncomingSession, error)
	...
	UpsertOORIncomingSession(ctx context.Context, arg UpsertOORIncomingSessionParams) error
