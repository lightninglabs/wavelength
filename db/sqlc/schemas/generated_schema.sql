...
CREATE TABLE ark_channels (
    ...
    updated_at BIGINT NOT NULL, client_recovery_ready BOOLEAN NOT NULL DEFAULT FALSE, hub_recovery_ready BOOLEAN NOT NULL DEFAULT FALSE, source_spent_outpoint_txid BLOB, source_spent_outpoint_index BIGINT, source_spending_txid BLOB, pre_ponr_started_at BIGINT,
