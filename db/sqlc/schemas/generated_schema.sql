...
CREATE TABLE vhtlc_recovery_jobs (
    ...
    -- preimage_hash is safe to persist and log. The raw preimage is never
    -- stored in this table and must be read from the swap state only when a
    -- claim spend is built.
