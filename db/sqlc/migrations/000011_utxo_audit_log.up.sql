...
-- Note: wallet and OOR tracking event types
-- (oor_transfer, wallet_deposit, wallet_spend, sweep_return,
-- round_funding) are seeded in migration 000010 alongside the
-- fee-model events so the ledger carries a single unified event
-- taxonomy.
