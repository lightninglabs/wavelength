-- Add the receive-claim channel kind while preserving the table's closed
-- enum constraint. SQLite requires a table rebuild to change a CHECK.
ALTER TABLE ark_channels RENAME TO ark_channels_v17;
...
SELECT
    ...
    hub_close_signed, client_close_finalized, hub_close_finalized, failure,
    revision, created_at, updated_at
FROM ark_channels_v17;

DROP TABLE ark_channels_v17;
