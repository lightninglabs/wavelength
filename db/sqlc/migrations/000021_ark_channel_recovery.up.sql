ALTER TABLE ark_channels ADD COLUMN client_recovery_ready BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE ark_channels ADD COLUMN hub_recovery_ready BOOLEAN NOT NULL DEFAULT FALSE;
