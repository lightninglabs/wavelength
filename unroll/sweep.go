...
// sane maximum. When the backend has no fee estimate yet, it falls back to a
// small floor so regtest sweeps can still proceed.
...
func buildSweepTx(ctx context.Context, wallet SweepWallet,
	...
	signDesc := scripts.VTXOSignDesc(
		desc.OwnerKey, targetOutput, sigHashes,
