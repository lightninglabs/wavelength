...
type GetBalanceResponse struct {
	...
	// total_sat is the sum of all confirmed balances (boarding confirmed
	// + vtxo).
	TotalSat      int64 `protobuf:"varint,4,opt,name=total_sat,json=totalSat,proto3" json:"total_sat,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetBalanceResponse) GetTotalSat() int64 {
	if x != nil {
		return x.TotalSat
	}
	return 0
...
func (x *SendOORRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *SendOORRequest) GetAmountSat() int64 {
	if x != nil {
		return x.AmountSat
	}
	return 0
...
type RefreshVTXOsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// outpoints lists specific VTXOs to refresh, in "txid:index" format.
	// Ignored if all is true.
...
func (x *RefreshVTXOsRequest) GetOutpoints() []string {
	if x != nil {
		return x.Outpoints
	}
	return nil
...
const file_daemon_proto_rawDesc = "" +
	...
	"\x10vtxo_balance_sat\x18\x03 \x01(\x03R\x0evtxoBalanceSat\x12\x1b\n" +
	"\ttotal_sat\x18\x04 \x01(\x03R\btotalSat\"\xc4\x02\n" +
	"\x04VTXO\x12\x1a\n" +
	...
	"\n" +
	"amount_sat\x18\x02 \x01(\x03R\tamountSat\"]\n" +
	...
	"\x10total_amount_sat\x18\x03 \x01(\x03R\x0etotalAmountSat\"b\n" +
	"\x0eSendOORRequest\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x1d\n" +
	"\n" +
	"amount_sat\x18\x02 \x01(\x03R\tamountSat\x12\x17\n" +
	"\adry_run\x18\x03 \x01(\bR\x06dryRun\"H\n" +
	"\x0fSendOORResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x1d\n" +
	"\n" +
	"session_id\x18\x02 \x01(\tR\tsessionId\"^\n" +
	"\x13RefreshVTXOsRequest\x12\x1c\n" +
	"\toutpoints\x18\x01 \x03(\tR\toutpoints\x12\x10\n" +
...
var file_daemon_proto_goTypes = []any{
	...
	(*RefreshVTXOsRequest)(nil),  // 21: daemonrpc.RefreshVTXOsRequest
	(*RefreshVTXOsResponse)(nil), // 22: daemonrpc.RefreshVTXOsResponse
}
var file_daemon_proto_depIdxs = []int32{
	...
	1,  // 4: daemonrpc.DaemonService.GetInfo:input_type -> daemonrpc.GetInfoRequest
	3,  // 5: daemonrpc.DaemonService.GenSeed:input_type -> daemonrpc.GenSeedRequest
	5,  // 6: daemonrpc.DaemonService.InitWallet:input_type -> daemonrpc.InitWalletRequest
	7,  // 7: daemonrpc.DaemonService.UnlockWallet:input_type -> daemonrpc.UnlockWalletRequest
	9,  // 8: daemonrpc.DaemonService.GetBalance:input_type -> daemonrpc.GetBalanceRequest
	12, // 9: daemonrpc.DaemonService.ListVTXOs:input_type -> daemonrpc.ListVTXOsRequest
	14, // 10: daemonrpc.DaemonService.NewAddress:input_type -> daemonrpc.NewAddressRequest
	17, // 11: daemonrpc.DaemonService.SendVTXO:input_type -> daemonrpc.SendVTXORequest
	19, // 12: daemonrpc.DaemonService.SendOOR:input_type -> daemonrpc.SendOORRequest
	21, // 13: daemonrpc.DaemonService.RefreshVTXOs:input_type -> daemonrpc.RefreshVTXOsRequest
	2,  // 14: daemonrpc.DaemonService.GetInfo:output_type -> daemonrpc.GetInfoResponse
	4,  // 15: daemonrpc.DaemonService.GenSeed:output_type -> daemonrpc.GenSeedResponse
	6,  // 16: daemonrpc.DaemonService.InitWallet:output_type -> daemonrpc.InitWalletResponse
	8,  // 17: daemonrpc.DaemonService.UnlockWallet:output_type -> daemonrpc.UnlockWalletResponse
	10, // 18: daemonrpc.DaemonService.GetBalance:output_type -> daemonrpc.GetBalanceResponse
	13, // 19: daemonrpc.DaemonService.ListVTXOs:output_type -> daemonrpc.ListVTXOsResponse
	15, // 20: daemonrpc.DaemonService.NewAddress:output_type -> daemonrpc.NewAddressResponse
	18, // 21: daemonrpc.DaemonService.SendVTXO:output_type -> daemonrpc.SendVTXOResponse
	20, // 22: daemonrpc.DaemonService.SendOOR:output_type -> daemonrpc.SendOORResponse
	22, // 23: daemonrpc.DaemonService.RefreshVTXOs:output_type -> daemonrpc.RefreshVTXOsResponse
