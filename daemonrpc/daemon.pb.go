...
type VirtualChannelVTXOInput struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// outpoint identifies the VTXO to use in "txid:vout" format. When no
	// explicit inputs are provided, the daemon selects and locks VTXOs.
	Outpoint string `protobuf:"bytes,1,opt,name=outpoint,proto3" json:"outpoint,omitempty"`
	// amount_sat is optional for caller-specified inputs. If omitted, the
	// daemon loads the amount from its VTXO store.
	AmountSat     int64 `protobuf:"varint,2,opt,name=amount_sat,json=amountSat,proto3" json:"amount_sat,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type VirtualChannelSelectedVTXO struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// outpoint identifies the selected backing VTXO in "txid:vout" format.
	Outpoint string `protobuf:"bytes,1,opt,name=outpoint,proto3" json:"outpoint,omitempty"`
	// amount_sat is the backing VTXO value.
	AmountSat     int64 `protobuf:"varint,2,opt,name=amount_sat,json=amountSat,proto3" json:"amount_sat,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type OpenVirtualChannelRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// peer_node_pubkey is the compressed lnd node pubkey of the operator peer.
	...
	// push_sat is the initial balance pushed to the remote peer.
...
const file_daemon_proto_rawDesc = "" +
	...
	"\boutpoint\x18\x01 \x01(\tR\boutpoint\x12\x1d\n" +
	"\n" +
	"amount_sat\x18\x02 \x01(\x03R\tamountSat\"\xc5\x02\n" +
	...
	"\tzero_conf\x18\x05 \x01(\bR\bzeroConf\x12G\n" +
	"\rbacking_vtxos\x18\x06 \x03(\v2\".daemonrpc.VirtualChannelVTXOInputR\fbackingVtxos\x12'\n" +
	"\x0fidempotency_key\x18\a \x01(\tR\x0eidempotencyKey\x12\x17\n" +
	"\adry_run\x18\b \x01(\bR\x06dryRun\"\xc5\x02\n" +
	...
	"\rchannel_point\x18\x04 \x01(\tR\fchannelPoint\x12L\n" +
	"\x0eselected_vtxos\x18\x05 \x03(\v2%.daemonrpc.VirtualChannelSelectedVTXOR\rselectedVtxos\x12\x1d\n" +
	"\n" +
	...
	"\x12\x1f\n" +
	"\x1bVHTLC_RECOVERY_STATE_FAILED\x10\v2\xb3\x1b\n" +
	"\rDaemonService\x12@\n" +
	...
	"\x12OpenVirtualChannel\x12$.daemonrpc.OpenVirtualChannelRequest\x1a%.daemonrpc.OpenVirtualChannelResponse\x12I\n" +
	"\n" +
...
var file_daemon_proto_goTypes = []any{
	...
	(VHTLCRecoveryDirection)(0),                   // 6: daemonrpc.VHTLCRecoveryDirection
	(VHTLCRecoveryAction)(0),                      // 7: daemonrpc.VHTLCRecoveryAction
	(VHTLCRecoveryState)(0),                       // 8: daemonrpc.VHTLCRecoveryState
	(*GetInfoRequest)(nil),                        // 9: daemonrpc.GetInfoRequest
	(*GetInfoResponse)(nil),                       // 10: daemonrpc.GetInfoResponse
	(*ServerInfo)(nil),                            // 11: daemonrpc.ServerInfo
	(*GenSeedRequest)(nil),                        // 12: daemonrpc.GenSeedRequest
	(*GenSeedResponse)(nil),                       // 13: daemonrpc.GenSeedResponse
	(*InitWalletRequest)(nil),                     // 14: daemonrpc.InitWalletRequest
	(*InitWalletResponse)(nil),                    // 15: daemonrpc.InitWalletResponse
	(*UnlockWalletRequest)(nil),                   // 16: daemonrpc.UnlockWalletRequest
	(*UnlockWalletResponse)(nil),                  // 17: daemonrpc.UnlockWalletResponse
	(*GetBalanceRequest)(nil),                     // 18: daemonrpc.GetBalanceRequest
	(*GetBalanceResponse)(nil),                    // 19: daemonrpc.GetBalanceResponse
	(*VTXO)(nil),                                  // 20: daemonrpc.VTXO
	(*ListVTXOsRequest)(nil),                      // 21: daemonrpc.ListVTXOsRequest
	(*ListVTXOsResponse)(nil),                     // 22: daemonrpc.ListVTXOsResponse
	(*NewAddressRequest)(nil),                     // 23: daemonrpc.NewAddressRequest
	(*NewAddressResponse)(nil),                    // 24: daemonrpc.NewAddressResponse
	(*NewReceiveScriptRequest)(nil),               // 25: daemonrpc.NewReceiveScriptRequest
	(*NewReceiveScriptResponse)(nil),              // 26: daemonrpc.NewReceiveScriptResponse
	(*ReceiveAuthKeyRequest)(nil),                 // 27: daemonrpc.ReceiveAuthKeyRequest
	(*ReceiveAuthKeyResponse)(nil),                // 28: daemonrpc.ReceiveAuthKeyResponse
	(*SignReceiveAuthMessageRequest)(nil),         // 29: daemonrpc.SignReceiveAuthMessageRequest
	...
	(*VirtualChannelVTXOInput)(nil),               // 54: daemonrpc.VirtualChannelVTXOInput
	(*VirtualChannelSelectedVTXO)(nil),            // 55: daemonrpc.VirtualChannelSelectedVTXO
	(*OpenVirtualChannelRequest)(nil),             // 56: daemonrpc.OpenVirtualChannelRequest
	(*OpenVirtualChannelResponse)(nil),            // 57: daemonrpc.OpenVirtualChannelResponse
...
var file_daemon_proto_depIdxs = []int32{
	...
	54,  // 17: daemonrpc.OpenVirtualChannelRequest.backing_vtxos:type_name -> daemonrpc.VirtualChannelVTXOInput
	55,  // 18: daemonrpc.OpenVirtualChannelResponse.selected_vtxos:type_name -> daemonrpc.VirtualChannelSelectedVTXO
	51,  // 19: daemonrpc.LeaveVTXOsRequest.outpoints:type_name -> daemonrpc.OutpointSelection
	58,  // 20: daemonrpc.LeaveVTXOsRequest.default_destination:type_name -> daemonrpc.LeaveDestination
	108, // 21: daemonrpc.LeaveVTXOsRequest.destinations:type_name -> daemonrpc.LeaveVTXOsRequest.DestinationsEntry
	66,  // 22: daemonrpc.SweepBoardingUTXOsResponse.sweepable_outputs:type_name -> daemonrpc.BoardingSweepOutput
	69,  // 23: daemonrpc.BoardingSweep.inputs:type_name -> daemonrpc.BoardingSweepInput
	70,  // 24: daemonrpc.ListBoardingSweepsResponse.sweeps:type_name -> daemonrpc.BoardingSweep
	2,   // 25: daemonrpc.RoundInfo.state:type_name -> daemonrpc.RoundState
	72,  // 26: daemonrpc.RoundInfo.vtxos:type_name -> daemonrpc.RoundVTXOInfo
	2,   // 27: daemonrpc.ListRoundsRequest.state_filter:type_name -> daemonrpc.RoundState
	73,  // 28: daemonrpc.GetRoundResponse.round:type_name -> daemonrpc.RoundInfo
	73,  // 29: daemonrpc.ListRoundsResponse.rounds:type_name -> daemonrpc.RoundInfo
	73,  // 30: daemonrpc.WatchRoundsResponse.round:type_name -> daemonrpc.RoundInfo
	3,   // 31: daemonrpc.OORSessionInfo.direction:type_name -> daemonrpc.OORSessionDirection
	4,   // 32: daemonrpc.OORSessionInfo.status:type_name -> daemonrpc.OORSessionStatus
	3,   // 33: daemonrpc.ListOORSessionsRequest.direction_filter:type_name -> daemonrpc.OORSessionDirection
	4,   // 34: daemonrpc.ListOORSessionsRequest.status_filter:type_name -> daemonrpc.OORSessionStatus
	80,  // 35: daemonrpc.ListOORSessionsResponse.sessions:type_name -> daemonrpc.OORSessionInfo
	80,  // 36: daemonrpc.GetOORSessionResponse.session:type_name -> daemonrpc.OORSessionInfo
	88,  // 37: daemonrpc.GetFeeHistoryResponse.entries:type_name -> daemonrpc.FeeHistoryEntry
	91,  // 38: daemonrpc.ListTransactionsResponse.transactions:type_name -> daemonrpc.TransactionHistoryEntry
	5,   // 39: daemonrpc.GetUnrollStatusResponse.status:type_name -> daemonrpc.UnrollJobStatus
	6,   // 40: daemonrpc.ArmVHTLCRecoveryRequest.direction:type_name -> daemonrpc.VHTLCRecoveryDirection
	7,   // 41: daemonrpc.ArmVHTLCRecoveryRequest.action:type_name -> daemonrpc.VHTLCRecoveryAction
	107, // 42: daemonrpc.ArmVHTLCRecoveryResponse.status:type_name -> daemonrpc.VHTLCRecoveryStatus
	107, // 43: daemonrpc.EscalateVHTLCRecoveryResponse.status:type_name -> daemonrpc.VHTLCRecoveryStatus
	107, // 44: daemonrpc.CancelVHTLCRecoveryResponse.status:type_name -> daemonrpc.VHTLCRecoveryStatus
	107, // 45: daemonrpc.GetVHTLCRecoveryStatusResponse.status:type_name -> daemonrpc.VHTLCRecoveryStatus
	107, // 46: daemonrpc.ListVHTLCRecoveriesResponse.statuses:type_name -> daemonrpc.VHTLCRecoveryStatus
	6,   // 47: daemonrpc.VHTLCRecoveryStatus.direction:type_name -> daemonrpc.VHTLCRecoveryDirection
	7,   // 48: daemonrpc.VHTLCRecoveryStatus.action:type_name -> daemonrpc.VHTLCRecoveryAction
	8,   // 49: daemonrpc.VHTLCRecoveryStatus.state:type_name -> daemonrpc.VHTLCRecoveryState
	5,   // 50: daemonrpc.VHTLCRecoveryStatus.unroll_status:type_name -> daemonrpc.UnrollJobStatus
	58,  // 51: daemonrpc.LeaveVTXOsRequest.DestinationsEntry.value:type_name -> daemonrpc.LeaveDestination
	9,   // 52: daemonrpc.DaemonService.GetInfo:input_type -> daemonrpc.GetInfoRequest
	12,  // 53: daemonrpc.DaemonService.GenSeed:input_type -> daemonrpc.GenSeedRequest
	14,  // 54: daemonrpc.DaemonService.InitWallet:input_type -> daemonrpc.InitWalletRequest
	16,  // 55: daemonrpc.DaemonService.UnlockWallet:input_type -> daemonrpc.UnlockWalletRequest
	18,  // 56: daemonrpc.DaemonService.GetBalance:input_type -> daemonrpc.GetBalanceRequest
	21,  // 57: daemonrpc.DaemonService.ListVTXOs:input_type -> daemonrpc.ListVTXOsRequest
	23,  // 58: daemonrpc.DaemonService.NewAddress:input_type -> daemonrpc.NewAddressRequest
	25,  // 59: daemonrpc.DaemonService.NewReceiveScript:input_type -> daemonrpc.NewReceiveScriptRequest
	27,  // 60: daemonrpc.DaemonService.ReceiveAuthKey:input_type -> daemonrpc.ReceiveAuthKeyRequest
	29,  // 61: daemonrpc.DaemonService.SignReceiveAuthMessage:input_type -> daemonrpc.SignReceiveAuthMessageRequest
	31,  // 62: daemonrpc.DaemonService.SignReceiveAuthMessageCompact:input_type -> daemonrpc.SignReceiveAuthMessageCompactRequest
	33,  // 63: daemonrpc.DaemonService.ReceiveAuthECDH:input_type -> daemonrpc.ReceiveAuthECDHRequest
	35,  // 64: daemonrpc.DaemonService.GetIndexedVTXOByPkScript:input_type -> daemonrpc.GetIndexedVTXOByPkScriptRequest
	37,  // 65: daemonrpc.DaemonService.GetIndexedOORSessionByTxid:input_type -> daemonrpc.GetIndexedOORSessionByTxidRequest
	40,  // 66: daemonrpc.DaemonService.SendVTXO:input_type -> daemonrpc.SendVTXORequest
	42,  // 67: daemonrpc.DaemonService.SendOOR:input_type -> daemonrpc.SendOORRequest
	46,  // 68: daemonrpc.DaemonService.PrepareOOR:input_type -> daemonrpc.PrepareOORRequest
	49,  // 69: daemonrpc.DaemonService.SignOORCustomInput:input_type -> daemonrpc.SignOORCustomInputRequest
	52,  // 70: daemonrpc.DaemonService.RefreshVTXOs:input_type -> daemonrpc.RefreshVTXOsRequest
	56,  // 71: daemonrpc.DaemonService.OpenVirtualChannel:input_type -> daemonrpc.OpenVirtualChannelRequest
	59,  // 72: daemonrpc.DaemonService.LeaveVTXOs:input_type -> daemonrpc.LeaveVTXOsRequest
	...
	34,  // 103: daemonrpc.DaemonService.ReceiveAuthECDH:output_type -> daemonrpc.ReceiveAuthECDHResponse
	36,  // 104: daemonrpc.DaemonService.GetIndexedVTXOByPkScript:output_type -> daemonrpc.GetIndexedVTXOByPkScriptResponse
	38,  // 105: daemonrpc.DaemonService.GetIndexedOORSessionByTxid:output_type -> daemonrpc.GetIndexedOORSessionByTxidResponse
	41,  // 106: daemonrpc.DaemonService.SendVTXO:output_type -> daemonrpc.SendVTXOResponse
	45,  // 107: daemonrpc.DaemonService.SendOOR:output_type -> daemonrpc.SendOORResponse
	48,  // 108: daemonrpc.DaemonService.PrepareOOR:output_type -> daemonrpc.PrepareOORResponse
	50,  // 109: daemonrpc.DaemonService.SignOORCustomInput:output_type -> daemonrpc.SignOORCustomInputResponse
	53,  // 110: daemonrpc.DaemonService.RefreshVTXOs:output_type -> daemonrpc.RefreshVTXOsResponse
	57,  // 111: daemonrpc.DaemonService.OpenVirtualChannel:output_type -> daemonrpc.OpenVirtualChannelResponse
	60,  // 112: daemonrpc.DaemonService.LeaveVTXOs:output_type -> daemonrpc.LeaveVTXOsResponse
	62,  // 113: daemonrpc.DaemonService.Board:output_type -> daemonrpc.BoardResponse
	64,  // 114: daemonrpc.DaemonService.JoinNextRound:output_type -> daemonrpc.JoinNextRoundResponse
	67,  // 115: daemonrpc.DaemonService.SweepBoardingUTXOs:output_type -> daemonrpc.SweepBoardingUTXOsResponse
	71,  // 116: daemonrpc.DaemonService.ListBoardingSweeps:output_type -> daemonrpc.ListBoardingSweepsResponse
	77,  // 117: daemonrpc.DaemonService.ListRounds:output_type -> daemonrpc.ListRoundsResponse
	76,  // 118: daemonrpc.DaemonService.GetRound:output_type -> daemonrpc.GetRoundResponse
	79,  // 119: daemonrpc.DaemonService.WatchRounds:output_type -> daemonrpc.WatchRoundsResponse
	82,  // 120: daemonrpc.DaemonService.ListOORSessions:output_type -> daemonrpc.ListOORSessionsResponse
	84,  // 121: daemonrpc.DaemonService.GetOORSession:output_type -> daemonrpc.GetOORSessionResponse
	86,  // 122: daemonrpc.DaemonService.EstimateFee:output_type -> daemonrpc.EstimateFeeResponse
	89,  // 123: daemonrpc.DaemonService.GetFeeHistory:output_type -> daemonrpc.GetFeeHistoryResponse
	92,  // 124: daemonrpc.DaemonService.ListTransactions:output_type -> daemonrpc.ListTransactionsResponse
	94,  // 125: daemonrpc.DaemonService.Unroll:output_type -> daemonrpc.UnrollResponse
	96,  // 126: daemonrpc.DaemonService.GetUnrollStatus:output_type -> daemonrpc.GetUnrollStatusResponse
	98,  // 127: daemonrpc.DaemonService.ArmVHTLCRecovery:output_type -> daemonrpc.ArmVHTLCRecoveryResponse
	100, // 128: daemonrpc.DaemonService.EscalateVHTLCRecovery:output_type -> daemonrpc.EscalateVHTLCRecoveryResponse
	102, // 129: daemonrpc.DaemonService.CancelVHTLCRecovery:output_type -> daemonrpc.CancelVHTLCRecoveryResponse
	104, // 130: daemonrpc.DaemonService.GetVHTLCRecoveryStatus:output_type -> daemonrpc.GetVHTLCRecoveryStatusResponse
	106, // 131: daemonrpc.DaemonService.ListVHTLCRecoveries:output_type -> daemonrpc.ListVHTLCRecoveriesResponse
