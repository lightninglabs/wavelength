...
// OORSessionDirection filters local OOR session listing by direction.
...
type ListOORSessionsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// pending_only excludes completed and failed sessions when true.
...
func (x *ListOORSessionsRequest) GetPendingOnly() bool {
	if x != nil {
...
func (x *ListOORSessionsRequest) GetDirection() OORSessionDirection {
	if x != nil {
		return x.Direction
	}
...
type ListOORSessionsResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// sessions contains the local OOR sessions matching the request filters.
	Sessions      []*OORSessionSummary `protobuf:"bytes,1,rep,name=sessions,proto3" json:"sessions,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListOORSessionsResponse) GetSessions() []*OORSessionSummary {
	if x != nil {
		return x.Sessions
	}
	return nil
...
type OORSessionSummary struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// session_id is the 32-byte OOR session identifier, hex encoded.
	SessionId string `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	// direction identifies whether this is an outgoing send or incoming
	// receive session.
	Direction OORSessionDirection `protobuf:"varint,2,opt,name=direction,proto3,enum=daemonrpc.OORSessionDirection" json:"direction,omitempty"`
	// phase is a stable snapshot phase such as submit_sent, finalize_sent,
	// resolve_pending, completed, or failed.
	Phase string `protobuf:"bytes,3,opt,name=phase,proto3" json:"phase,omitempty"`
	// pending is true while the local session is not terminal.
	Pending bool `protobuf:"varint,4,opt,name=pending,proto3" json:"pending,omitempty"`
	// retry_after_ms is non-zero when local retry metadata is present.
	RetryAfterMs int64 `protobuf:"varint,5,opt,name=retry_after_ms,json=retryAfterMs,proto3" json:"retry_after_ms,omitempty"`
	// retry_reason describes the pending retry, or the terminal failure.
	RetryReason string `protobuf:"bytes,6,opt,name=retry_reason,json=retryReason,proto3" json:"retry_reason,omitempty"`
	// input_outpoints are outgoing input VTXOs, formatted as txid:vout.
	InputOutpoints []string `protobuf:"bytes,7,rep,name=input_outpoints,json=inputOutpoints,proto3" json:"input_outpoints,omitempty"`
	// input_amount_sat is the sum of outgoing input amounts when known.
...
func (x *OORSessionSummary) Reset() {
	*x = OORSessionSummary{}
...
func (x *OORSessionSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OORSessionSummary) ProtoMessage() {}

func (x *OORSessionSummary) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OORSessionSummary.ProtoReflect.Descriptor instead.
func (*OORSessionSummary) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{24}
}

func (x *OORSessionSummary) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *OORSessionSummary) GetDirection() OORSessionDirection {
	if x != nil {
		return x.Direction
	}
	return OORSessionDirection_OOR_SESSION_DIRECTION_ALL
...
func (x *OORSessionSummary) GetPhase() string {
	if x != nil {
		return x.Phase
	}
	return ""
...
func (x *OORSessionSummary) GetPending() bool {
	if x != nil {
		return x.Pending
	}
	return false
...
func (x *OORSessionSummary) GetRetryAfterMs() int64 {
	if x != nil {
...
func (x *OORSessionSummary) GetRetryReason() string {
	if x != nil {
...
func (x *OORSessionSummary) GetInputOutpoints() []string {
	if x != nil {
...
func (x *OORSessionSummary) GetInputAmountSat() int64 {
	if x != nil {
		return x.InputAmountSat
	}
	return 0
}

func (x *OORSessionSummary) GetRecipientCount() int32 {
	if x != nil {
...
const file_daemon_proto_rawDesc = "" +
	...
	"\tdirection\x18\x02 \x01(\x0e2\x1e.daemonrpc.OORSessionDirectionR\tdirection\x12\x14\n" +
	...
	"\x14VTXO_STATUS_SPENDING\x10\b*|\n" +
	"\x13OORSessionDirection\x12\x1d\n" +
	"\x19OOR_SESSION_DIRECTION_ALL\x10\x00\x12\"\n" +
	"\x1eOOR_SESSION_DIRECTION_OUTGOING\x10\x01\x12\"\n" +
	"\x1eOOR_SESSION_DIRECTION_INCOMING\x10\x02*\xf7\x03\n" +
	"\n" +
	"RoundState\x12\x17\n" +
	...
	"\x18UNROLL_JOB_STATUS_FAILED\x10\x062\xe9\r\n" +
	"\rDaemonService\x12@\n" +
	...
	"\x1aGetIndexedOORSessionByTxid\x12,.daemonrpc.GetIndexedOORSessionByTxidRequest\x1a-.daemonrpc.GetIndexedOORSessionByTxidResponse\x12X\n" +
	"\x0fListOORSessions\x12!.daemonrpc.ListOORSessionsRequest\x1a\".daemonrpc.ListOORSessionsResponse\x12C\n" +
...
var file_daemon_proto_goTypes = []any{
	...
	(OORSessionDirection)(0),                   // 1: daemonrpc.OORSessionDirection
	(RoundState)(0),                            // 2: daemonrpc.RoundState
	(UnrollJobStatus)(0),                       // 3: daemonrpc.UnrollJobStatus
	(*GetInfoRequest)(nil),                     // 4: daemonrpc.GetInfoRequest
	(*GetInfoResponse)(nil),                    // 5: daemonrpc.GetInfoResponse
	(*ServerInfo)(nil),                         // 6: daemonrpc.ServerInfo
	(*GenSeedRequest)(nil),                     // 7: daemonrpc.GenSeedRequest
	(*GenSeedResponse)(nil),                    // 8: daemonrpc.GenSeedResponse
	(*InitWalletRequest)(nil),                  // 9: daemonrpc.InitWalletRequest
	(*InitWalletResponse)(nil),                 // 10: daemonrpc.InitWalletResponse
	(*UnlockWalletRequest)(nil),                // 11: daemonrpc.UnlockWalletRequest
	(*UnlockWalletResponse)(nil),               // 12: daemonrpc.UnlockWalletResponse
	(*GetBalanceRequest)(nil),                  // 13: daemonrpc.GetBalanceRequest
	(*GetBalanceResponse)(nil),                 // 14: daemonrpc.GetBalanceResponse
	(*VTXO)(nil),                               // 15: daemonrpc.VTXO
	(*ListVTXOsRequest)(nil),                   // 16: daemonrpc.ListVTXOsRequest
	(*ListVTXOsResponse)(nil),                  // 17: daemonrpc.ListVTXOsResponse
	(*NewAddressRequest)(nil),                  // 18: daemonrpc.NewAddressRequest
	(*NewAddressResponse)(nil),                 // 19: daemonrpc.NewAddressResponse
	(*NewReceiveScriptRequest)(nil),            // 20: daemonrpc.NewReceiveScriptRequest
	(*NewReceiveScriptResponse)(nil),           // 21: daemonrpc.NewReceiveScriptResponse
	(*GetIndexedVTXOByPkScriptRequest)(nil),    // 22: daemonrpc.GetIndexedVTXOByPkScriptRequest
	(*GetIndexedVTXOByPkScriptResponse)(nil),   // 23: daemonrpc.GetIndexedVTXOByPkScriptResponse
	(*GetIndexedOORSessionByTxidRequest)(nil),  // 24: daemonrpc.GetIndexedOORSessionByTxidRequest
	(*GetIndexedOORSessionByTxidResponse)(nil), // 25: daemonrpc.GetIndexedOORSessionByTxidResponse
	(*ListOORSessionsRequest)(nil),             // 26: daemonrpc.ListOORSessionsRequest
	(*ListOORSessionsResponse)(nil),            // 27: daemonrpc.ListOORSessionsResponse
	(*OORSessionSummary)(nil),                  // 28: daemonrpc.OORSessionSummary
	(*Output)(nil),                             // 29: daemonrpc.Output
	(*SendVTXORequest)(nil),                    // 30: daemonrpc.SendVTXORequest
	(*SendVTXOResponse)(nil),                   // 31: daemonrpc.SendVTXOResponse
	(*SendOORRequest)(nil),                     // 32: daemonrpc.SendOORRequest
	(*CustomOORInput)(nil),                     // 33: daemonrpc.CustomOORInput
	(*SendOORResponse)(nil),                    // 34: daemonrpc.SendOORResponse
	(*OutpointSelection)(nil),                  // 35: daemonrpc.OutpointSelection
	(*RefreshVTXOsRequest)(nil),                // 36: daemonrpc.RefreshVTXOsRequest
	(*RefreshVTXOsResponse)(nil),               // 37: daemonrpc.RefreshVTXOsResponse
	(*LeaveDestination)(nil),                   // 38: daemonrpc.LeaveDestination
	(*LeaveVTXOsRequest)(nil),                  // 39: daemonrpc.LeaveVTXOsRequest
	(*LeaveVTXOsResponse)(nil),                 // 40: daemonrpc.LeaveVTXOsResponse
	(*BoardRequest)(nil),                       // 41: daemonrpc.BoardRequest
	(*BoardResponse)(nil),                      // 42: daemonrpc.BoardResponse
	(*RoundVTXOInfo)(nil),                      // 43: daemonrpc.RoundVTXOInfo
	(*RoundInfo)(nil),                          // 44: daemonrpc.RoundInfo
	(*ListRoundsRequest)(nil),                  // 45: daemonrpc.ListRoundsRequest
	...
	(*EstimateFeeRequest)(nil),                 // 49: daemonrpc.EstimateFeeRequest
	(*EstimateFeeResponse)(nil),                // 50: daemonrpc.EstimateFeeResponse
	(*GetFeeHistoryRequest)(nil),               // 51: daemonrpc.GetFeeHistoryRequest
	(*FeeHistoryEntry)(nil),                    // 52: daemonrpc.FeeHistoryEntry
	(*GetFeeHistoryResponse)(nil),              // 53: daemonrpc.GetFeeHistoryResponse
	(*UnrollRequest)(nil),                      // 54: daemonrpc.UnrollRequest
	(*UnrollResponse)(nil),                     // 55: daemonrpc.UnrollResponse
	(*GetUnrollStatusRequest)(nil),             // 56: daemonrpc.GetUnrollStatusRequest
	(*GetUnrollStatusResponse)(nil),            // 57: daemonrpc.GetUnrollStatusResponse
	nil,                                        // 58: daemonrpc.LeaveVTXOsRequest.DestinationsEntry
}
var file_daemon_proto_depIdxs = []int32{
	6,  // 0: daemonrpc.GetInfoResponse.server_info:type_name -> daemonrpc.ServerInfo
	...
	15, // 3: daemonrpc.ListVTXOsResponse.vtxos:type_name -> daemonrpc.VTXO
	0,  // 4: daemonrpc.GetIndexedVTXOByPkScriptRequest.status_filter:type_name -> daemonrpc.VTXOStatus
	15, // 5: daemonrpc.GetIndexedVTXOByPkScriptResponse.vtxo:type_name -> daemonrpc.VTXO
	1,  // 6: daemonrpc.ListOORSessionsRequest.direction:type_name -> daemonrpc.OORSessionDirection
	28, // 7: daemonrpc.ListOORSessionsResponse.sessions:type_name -> daemonrpc.OORSessionSummary
	1,  // 8: daemonrpc.OORSessionSummary.direction:type_name -> daemonrpc.OORSessionDirection
	29, // 9: daemonrpc.SendVTXORequest.recipients:type_name -> daemonrpc.Output
	29, // 10: daemonrpc.SendOORRequest.recipient:type_name -> daemonrpc.Output
	33, // 11: daemonrpc.SendOORRequest.custom_inputs:type_name -> daemonrpc.CustomOORInput
	35, // 12: daemonrpc.RefreshVTXOsRequest.outpoints:type_name -> daemonrpc.OutpointSelection
	35, // 13: daemonrpc.LeaveVTXOsRequest.outpoints:type_name -> daemonrpc.OutpointSelection
	38, // 14: daemonrpc.LeaveVTXOsRequest.default_destination:type_name -> daemonrpc.LeaveDestination
	58, // 15: daemonrpc.LeaveVTXOsRequest.destinations:type_name -> daemonrpc.LeaveVTXOsRequest.DestinationsEntry
	2,  // 16: daemonrpc.RoundInfo.state:type_name -> daemonrpc.RoundState
	43, // 17: daemonrpc.RoundInfo.vtxos:type_name -> daemonrpc.RoundVTXOInfo
	44, // 18: daemonrpc.ListRoundsResponse.rounds:type_name -> daemonrpc.RoundInfo
	44, // 19: daemonrpc.WatchRoundsResponse.round:type_name -> daemonrpc.RoundInfo
	52, // 20: daemonrpc.GetFeeHistoryResponse.entries:type_name -> daemonrpc.FeeHistoryEntry
	3,  // 21: daemonrpc.GetUnrollStatusResponse.status:type_name -> daemonrpc.UnrollJobStatus
	38, // 22: daemonrpc.LeaveVTXOsRequest.DestinationsEntry.value:type_name -> daemonrpc.LeaveDestination
	4,  // 23: daemonrpc.DaemonService.GetInfo:input_type -> daemonrpc.GetInfoRequest
	7,  // 24: daemonrpc.DaemonService.GenSeed:input_type -> daemonrpc.GenSeedRequest
	9,  // 25: daemonrpc.DaemonService.InitWallet:input_type -> daemonrpc.InitWalletRequest
	11, // 26: daemonrpc.DaemonService.UnlockWallet:input_type -> daemonrpc.UnlockWalletRequest
	13, // 27: daemonrpc.DaemonService.GetBalance:input_type -> daemonrpc.GetBalanceRequest
	16, // 28: daemonrpc.DaemonService.ListVTXOs:input_type -> daemonrpc.ListVTXOsRequest
	18, // 29: daemonrpc.DaemonService.NewAddress:input_type -> daemonrpc.NewAddressRequest
	20, // 30: daemonrpc.DaemonService.NewReceiveScript:input_type -> daemonrpc.NewReceiveScriptRequest
	22, // 31: daemonrpc.DaemonService.GetIndexedVTXOByPkScript:input_type -> daemonrpc.GetIndexedVTXOByPkScriptRequest
	24, // 32: daemonrpc.DaemonService.GetIndexedOORSessionByTxid:input_type -> daemonrpc.GetIndexedOORSessionByTxidRequest
	26, // 33: daemonrpc.DaemonService.ListOORSessions:input_type -> daemonrpc.ListOORSessionsRequest
	30, // 34: daemonrpc.DaemonService.SendVTXO:input_type -> daemonrpc.SendVTXORequest
	32, // 35: daemonrpc.DaemonService.SendOOR:input_type -> daemonrpc.SendOORRequest
	36, // 36: daemonrpc.DaemonService.RefreshVTXOs:input_type -> daemonrpc.RefreshVTXOsRequest
	39, // 37: daemonrpc.DaemonService.LeaveVTXOs:input_type -> daemonrpc.LeaveVTXOsRequest
	41, // 38: daemonrpc.DaemonService.Board:input_type -> daemonrpc.BoardRequest
	45, // 39: daemonrpc.DaemonService.ListRounds:input_type -> daemonrpc.ListRoundsRequest
	47, // 40: daemonrpc.DaemonService.WatchRounds:input_type -> daemonrpc.WatchRoundsRequest
	49, // 41: daemonrpc.DaemonService.EstimateFee:input_type -> daemonrpc.EstimateFeeRequest
	51, // 42: daemonrpc.DaemonService.GetFeeHistory:input_type -> daemonrpc.GetFeeHistoryRequest
	54, // 43: daemonrpc.DaemonService.Unroll:input_type -> daemonrpc.UnrollRequest
	56, // 44: daemonrpc.DaemonService.GetUnrollStatus:input_type -> daemonrpc.GetUnrollStatusRequest
	5,  // 45: daemonrpc.DaemonService.GetInfo:output_type -> daemonrpc.GetInfoResponse
	8,  // 46: daemonrpc.DaemonService.GenSeed:output_type -> daemonrpc.GenSeedResponse
	10, // 47: daemonrpc.DaemonService.InitWallet:output_type -> daemonrpc.InitWalletResponse
	12, // 48: daemonrpc.DaemonService.UnlockWallet:output_type -> daemonrpc.UnlockWalletResponse
	14, // 49: daemonrpc.DaemonService.GetBalance:output_type -> daemonrpc.GetBalanceResponse
	17, // 50: daemonrpc.DaemonService.ListVTXOs:output_type -> daemonrpc.ListVTXOsResponse
	19, // 51: daemonrpc.DaemonService.NewAddress:output_type -> daemonrpc.NewAddressResponse
	21, // 52: daemonrpc.DaemonService.NewReceiveScript:output_type -> daemonrpc.NewReceiveScriptResponse
	23, // 53: daemonrpc.DaemonService.GetIndexedVTXOByPkScript:output_type -> daemonrpc.GetIndexedVTXOByPkScriptResponse
	25, // 54: daemonrpc.DaemonService.GetIndexedOORSessionByTxid:output_type -> daemonrpc.GetIndexedOORSessionByTxidResponse
	27, // 55: daemonrpc.DaemonService.ListOORSessions:output_type -> daemonrpc.ListOORSessionsResponse
	31, // 56: daemonrpc.DaemonService.SendVTXO:output_type -> daemonrpc.SendVTXOResponse
	34, // 57: daemonrpc.DaemonService.SendOOR:output_type -> daemonrpc.SendOORResponse
	37, // 58: daemonrpc.DaemonService.RefreshVTXOs:output_type -> daemonrpc.RefreshVTXOsResponse
	40, // 59: daemonrpc.DaemonService.LeaveVTXOs:output_type -> daemonrpc.LeaveVTXOsResponse
	42, // 60: daemonrpc.DaemonService.Board:output_type -> daemonrpc.BoardResponse
	46, // 61: daemonrpc.DaemonService.ListRounds:output_type -> daemonrpc.ListRoundsResponse
	48, // 62: daemonrpc.DaemonService.WatchRounds:output_type -> daemonrpc.WatchRoundsResponse
	50, // 63: daemonrpc.DaemonService.EstimateFee:output_type -> daemonrpc.EstimateFeeResponse
	53, // 64: daemonrpc.DaemonService.GetFeeHistory:output_type -> daemonrpc.GetFeeHistoryResponse
	55, // 65: daemonrpc.DaemonService.Unroll:output_type -> daemonrpc.UnrollResponse
	57, // 66: daemonrpc.DaemonService.GetUnrollStatus:output_type -> daemonrpc.GetUnrollStatusResponse
...
func file_daemon_proto_init() {
	...
	file_daemon_proto_msgTypes[25].OneofWrappers = []any{
		(*Output_Address)(nil),
		(*Output_Pubkey)(nil),
