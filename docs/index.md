...
| [mailbox_ingress_safety.md](mailbox_ingress_safety.md) | Commit-before-ack on durable event routes: `delivery-v1:` occurrence IDs and their 30-day replay receipts, local quarantine of rejected envelopes, cursor consistency checks before dispatch, and what the mechanism does *not* prove about consumer idempotency |
