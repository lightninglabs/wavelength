...
| [mailbox_ingress_safety.md](mailbox_ingress_safety.md) | Ingress safety and recovery: `delivery-v1:` occurrence IDs for durable replay protection, commit-before-ack handoff, ingress receipts, and the quarantine path for contradicted or rejected envelopes |
