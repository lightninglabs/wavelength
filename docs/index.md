...
| [mailbox_ingress_safety.md](mailbox_ingress_safety.md) | Ingress safety on the mailbox: commit-before-ack for durable routes, `delivery-v1:` replay receipts and their occurrence scope, quarantine of rejected/contradictory envelopes, and cursor-consistency checks before dispatch |
