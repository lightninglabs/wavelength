...
| [mailbox_ingress_safety.md](mailbox_ingress_safety.md) | Ingress evidence contracts: occurrence IDs scoped to the reply mailbox, 30-day delivery receipts consumed at durable inbox insertion, and bounded poison quarantine with per-lane reservations |
