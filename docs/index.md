...
| [mailbox_ingress_safety.md](mailbox_ingress_safety.md) | Ack-before-delete safety on ingress: `delivery-v1:` occurrence IDs and replay retention, durable ingress receipts, envelope quarantine, and cursor consistency checks before dispatch |
