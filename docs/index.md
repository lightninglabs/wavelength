...
| [mailbox_ingress_safety.md](mailbox_ingress_safety.md) | Ingress acknowledgement safety: `delivery-v1:` occurrence receipts and replay retention, durable quarantine of rejected envelopes, in-memory route durability limits, and cursor consistency checked before dispatch |
