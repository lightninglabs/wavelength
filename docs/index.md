...
| [credit_durable_actor_design.md](credit_durable_actor_design.md) | Credit subsystem durable-actor design: the three multi-step credit flows run as durable per-operation protofsm actors |
...
| [walletdk_mobile.md](walletdk_mobile.md) | `sdk/walletdk/mobile`: gomobile-safe facade over the wallet SDK for embedding a wallet in Android/iOS hosts |
