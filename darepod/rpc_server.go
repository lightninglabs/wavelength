...
func (r *RPCServer) GetInfo(ctx context.Context,
	...
	// IdentityPubkey is the daemon identity key derived from the active
	// wallet backend. For lnd-backed daemons this intentionally differs
	// from the public node key above and must stay aligned with the
	// proof signer used for script-scoped VTXO queries.
