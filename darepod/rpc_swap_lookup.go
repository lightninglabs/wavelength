...
func indexerStatusToDaemonStatus(status arkrpc.VTXOStatus) (
	...
	case arkrpc.VTXOStatus_VTXO_STATUS_UNSPECIFIED:
		return daemonrpc.VTXOStatus_VTXO_STATUS_UNSPECIFIED, nil

	case arkrpc.VTXOStatus_VTXO_STATUS_LIVE:
		return daemonrpc.VTXOStatus_VTXO_STATUS_LIVE, nil

	case arkrpc.VTXOStatus_VTXO_STATUS_PENDING_FORFEIT:
		return daemonrpc.VTXOStatus_VTXO_STATUS_PENDING_FORFEIT, nil

	case arkrpc.VTXOStatus_VTXO_STATUS_FORFEITING:
		return daemonrpc.VTXOStatus_VTXO_STATUS_FORFEITING, nil

	case arkrpc.VTXOStatus_VTXO_STATUS_FORFEITED:
		return daemonrpc.VTXOStatus_VTXO_STATUS_FORFEITED, nil

	case arkrpc.VTXOStatus_VTXO_STATUS_SPENT:
		return daemonrpc.VTXOStatus_VTXO_STATUS_SPENT, nil

	case arkrpc.VTXOStatus_VTXO_STATUS_UNILATERAL_EXIT:
		return daemonrpc.VTXOStatus_VTXO_STATUS_UNILATERAL_EXIT, nil

	case arkrpc.VTXOStatus_VTXO_STATUS_FAILED:
		return daemonrpc.VTXOStatus_VTXO_STATUS_FAILED, nil
