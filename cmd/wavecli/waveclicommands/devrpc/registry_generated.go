	...
	return []serviceSpec{
		{
			...
			Methods: []methodSpec{
				...
				},
				{
					...
					Aliases:  []string{"list-dead-letters"},
					Input:    "waverpc.ListDeadLettersRequest",
					Output:   "waverpc.ListDeadLettersResponse",
					Comments: "ListDeadLetters returns dead-lettered actor messages (messages a\ndurable actor abandoned after exhausting delivery retries) for\noperator inspection, newest first.",
				},
				{
					Name:     "GetDeadLetter",
					Aliases:  []string{"get-dead-letter"},
					Input:    "waverpc.GetDeadLetterRequest",
					Output:   "waverpc.GetDeadLetterResponse",
					Comments: "GetDeadLetter returns a single dead letter by ID, including its\npayload.",
				},
				{
					Name:     "RequeueDeadLetter",
					Aliases:  []string{"requeue-dead-letter"},
					Input:    "waverpc.RequeueDeadLetterRequest",
					Output:   "waverpc.RequeueDeadLetterResponse",
					Comments: "RequeueDeadLetter re-enqueues a dead letter into its original actor\nmailbox under a fresh message ID (attempts reset, routing preserved)\nand removes it from the dead-letter queue.",
				},
				{
					Name:     "PurgeDeadLetters",
					Aliases:  []string{"purge-dead-letters"},
					Input:    "waverpc.PurgeDeadLettersRequest",
					Output:   "waverpc.PurgeDeadLettersResponse",
					Comments: "PurgeDeadLetters permanently deletes dead letters older than the\ngiven age.",
				},
			},
		},
		{
