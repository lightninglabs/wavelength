	...
	return []serviceSpec{
		{
			...
			Methods: []methodSpec{
				...
				{
					Name:     "PrepareArkChannelOOR",
					Aliases:  []string{"prepare-ark-channel-oor"},
					Input:    "waverpc.PrepareArkChannelOORRequest",
					Output:   "waverpc.PrepareArkChannelOORResponse",
				...
				},
				{
					...
					Output:   "waverpc.ValidatePreparedArkChannelOORResponse",
					Comments: "ValidatePreparedArkChannelOOR verifies that a binding still names the\nexact prepared daemon OOR session.",
				},
				{
					Name:     "CommitPreparedArkChannelOOR",
					Aliases:  []string{"commit-prepared-ark-channel-oor"},
					Input:    "waverpc.CommitPreparedArkChannelOORRequest",
					Output:   "waverpc.CommitPreparedArkChannelOORResponse",
					Comments: "CommitPreparedArkChannelOOR releases the prepared OOR only after both\nlnd endpoints have persisted the fully signed channel backing.",
				},
				{
					Name:     "AbortPreparedArkChannelOOR",
					Aliases:  []string{"abort-prepared-ark-channel-oor"},
					Input:    "waverpc.AbortPreparedArkChannelOORRequest",
					Output:   "waverpc.AbortPreparedArkChannelOORResponse",
					Comments: "AbortPreparedArkChannelOOR releases a pre-signing channel reservation.",
				},
				{
					Name:     "SendVTXO",
