...
type testDaemonServer struct {
	...
	listReq    *daemonrpc.ListVTXOsRequest
	sendReq    *daemonrpc.SendVTXORequest
	oorReq     *daemonrpc.SendOORRequest
	refreshReq *daemonrpc.RefreshVTXOsRequest
	authReq    *daemonrpc.ReceiveAuthKeyRequest
}

func (s *testDaemonServer) GetInfo(context.Context, *daemonrpc.GetInfoRequest) (
...
func (s *testDaemonServer) ReceiveAuthKey(_ context.Context,
	...
	*daemonrpc.ReceiveAuthKeyResponse, error) {
	...
	return &daemonrpc.ReceiveAuthKeyResponse{}, nil
}
...
func newTestDevCmd(t *testing.T, server daemonrpc.DaemonServiceServer,
	...
	daemonrpc.RegisterDaemonServiceServer(grpcServer, server)
