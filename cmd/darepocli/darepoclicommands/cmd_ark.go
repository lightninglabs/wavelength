...
// commands targeting raw daemonrpc methods: VTXO inventory and
...
func newArkCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "ark",
		Short: "Advanced Ark protocol commands (raw daemonrpc)",
		Long: "Power-user subcommands that surface the raw daemonrpc " +
...
// listTransactions executes the daemonrpc.ListTransactions RPC.
