...
func newWalletCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long:  "Manage the daemon wallet: create, unlock, check balance, generate addresses.",
	}
...
func readPassword(cmd *cobra.Command) ([]byte, error) {
	...
	// Interactive prompt (TTY). Use term.ReadPassword to
	// suppress terminal echo so the password is not visible.
