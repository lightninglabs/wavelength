...
// TryTell mirrors Tell for the non-blocking TellOnlyRef contract; the
// recording ref never applies backpressure, so it simply delegates.
func (r *recordingBoardingSweepRef) TryTell(ctx context.Context,
	msg wallet.WalletMsg) error {
