...
func exitStatusFromDaemon(s daemonrpc.UnrollJobStatus) walletrpc.ExitJobStatus {
	switch s {
	case daemonrpc.UnrollJobStatus_UNROLL_JOB_STATUS_PENDING:
		return walletrpc.ExitJobStatus_EXIT_JOB_STATUS_PENDING

	case daemonrpc.UnrollJobStatus_UNROLL_JOB_STATUS_MATERIALIZING:
		return walletrpc.ExitJobStatus_EXIT_JOB_STATUS_MATERIALIZING

	case daemonrpc.UnrollJobStatus_UNROLL_JOB_STATUS_CSV_PENDING:
		return walletrpc.ExitJobStatus_EXIT_JOB_STATUS_CSV_PENDING

	case daemonrpc.UnrollJobStatus_UNROLL_JOB_STATUS_SWEEPING:
		return walletrpc.ExitJobStatus_EXIT_JOB_STATUS_SWEEPING

	case daemonrpc.UnrollJobStatus_UNROLL_JOB_STATUS_COMPLETED:
		return walletrpc.ExitJobStatus_EXIT_JOB_STATUS_COMPLETED

	case daemonrpc.UnrollJobStatus_UNROLL_JOB_STATUS_FAILED:
		return walletrpc.ExitJobStatus_EXIT_JOB_STATUS_FAILED

	default:
		return walletrpc.ExitJobStatus_EXIT_JOB_STATUS_UNSPECIFIED
	}
}
