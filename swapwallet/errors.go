...
var (
	...
	ErrSwapBackendUnavailable = errors.New(
		"swap backend handle is unavailable",
	)
	...
	ErrInvalidDestination = errors.New(
		"send destination must set invoice or onchain_address",
	)
	...
	ErrAmountRequired = errors.New(
		"amt_sat is required for the requested send",
	)
	...
	ErrUnsupportedKind = errors.New(
		"unsupported entry kind in list filter",
	)
