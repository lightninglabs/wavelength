...
// AddressCreated is emitted when the boarding address has been generated and
// is ready for funding. The actor has derived the necessary keys and built the
// boarding tapscript. The client should fund this address to proceed.
type AddressCreated struct {
	// Address is the taproot boarding address where funds should be sent.
	Address btcutil.Address

	// Tapscript is the complete boarding tapscript with collaborative and
	// timeout paths.
	Tapscript *waddrmgr.Tapscript

	// ClientKey is the client's key used in the boarding script.
	ClientKey *btcec.PublicKey

	// OperatorKey is the operator's key used in the boarding script.
	OperatorKey *btcec.PublicKey

	// ExpectedAmount is the recommended amount to send (sum of VTXO
	// requests + fees).
	ExpectedAmount fn.Option[btcutil.Amount]
}

func (e *AddressCreated) clientEventSealed() {}
...
func (m *JoinRoundRequest) clientEventSealed() {}
...
type SubmitNoncesRequest struct {
	...
	// Nonces are the MuSig2 public nonces for all transactions in the
	// client's VTXT path.
	Nonces [][]byte
}

func (m *SubmitNoncesRequest) clientEventSealed() {}
...
func (m *SubmitPartialSigRequest) clientEventSealed() {}
...
func (m *SubmitForfeitSigRequest) clientEventSealed() {}
...
func (m *RegisterConfirmationRequest) clientEventSealed() {}
...
func (m *VTXOCreatedNotification) clientEventSealed() {}
...
func (m *RoundCompletedNotification) clientEventSealed() {}
...
func (m *RoundCheckpointedNotification) clientEventSealed() {}
