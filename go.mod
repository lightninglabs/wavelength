module github.com/lightninglabs/darepo
...
// Keep the top-level btcwallet module aligned with the 0.21 lnd/lndclient
// stack while taproot-assets still requires the released v0.16.17 tag. The
// btcwallet submodules below remain on their released tags.
