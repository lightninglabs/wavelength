...
var file_daemon_proto_depIdxs = []int32{
	...
	77,  // 33: waverpc.LeaveVTXOsRequest.default_destination:type_name -> waverpc.LeaveDestination
	132, // 34: waverpc.LeaveVTXOsRequest.destinations:type_name -> waverpc.LeaveVTXOsRequest.DestinationsEntry
	77,  // 35: waverpc.SendOnChainRequest.destination:type_name -> waverpc.LeaveDestination
	87,  // 36: waverpc.SweepBoardingUTXOsResponse.sweepable_outputs:type_name -> waverpc.BoardingSweepOutput
	90,  // 37: waverpc.BoardingSweep.inputs:type_name -> waverpc.BoardingSweepInput
	91,  // 38: waverpc.ListBoardingSweepsResponse.sweeps:type_name -> waverpc.BoardingSweep
	4,   // 39: waverpc.RoundInfo.state:type_name -> waverpc.RoundState
	93,  // 40: waverpc.RoundInfo.vtxos:type_name -> waverpc.RoundVTXOInfo
	4,   // 41: waverpc.ListRoundsRequest.state_filter:type_name -> waverpc.RoundState
	94,  // 42: waverpc.GetRoundResponse.round:type_name -> waverpc.RoundInfo
	94,  // 43: waverpc.ListRoundsResponse.rounds:type_name -> waverpc.RoundInfo
	94,  // 44: waverpc.WatchRoundsResponse.round:type_name -> waverpc.RoundInfo
	...
	101, // 49: waverpc.ListOORSessionsResponse.sessions:type_name -> waverpc.OORSessionInfo
	101, // 50: waverpc.GetOORSessionResponse.session:type_name -> waverpc.OORSessionInfo
	109, // 51: waverpc.GetFeeHistoryResponse.entries:type_name -> waverpc.FeeHistoryEntry
	112, // 52: waverpc.ListTransactionsResponse.transactions:type_name -> waverpc.TransactionHistoryEntry
	7,   // 53: waverpc.GetUnrollStatusResponse.status:type_name -> waverpc.UnrollJobStatus
	117, // 54: waverpc.GetUnrollStatusResponse.progress:type_name -> waverpc.UnrollProgress
	118, // 55: waverpc.GetUnrollStatusResponse.csv:type_name -> waverpc.UnrollCSV
	119, // 56: waverpc.GetUnrollStatusResponse.fees:type_name -> waverpc.UnrollFees
	...
	131, // 59: waverpc.ArmVHTLCRecoveryResponse.status:type_name -> waverpc.VHTLCRecoveryStatus
	131, // 60: waverpc.EscalateVHTLCRecoveryResponse.status:type_name -> waverpc.VHTLCRecoveryStatus
	131, // 61: waverpc.CancelVHTLCRecoveryResponse.status:type_name -> waverpc.VHTLCRecoveryStatus
	131, // 62: waverpc.GetVHTLCRecoveryStatusResponse.status:type_name -> waverpc.VHTLCRecoveryStatus
	131, // 63: waverpc.ListVHTLCRecoveriesResponse.statuses:type_name -> waverpc.VHTLCRecoveryStatus
	...
	77,  // 68: waverpc.LeaveVTXOsRequest.DestinationsEntry.value:type_name -> waverpc.LeaveDestination
	...
	69,  // 90: waverpc.DaemonService.RefreshCustomVTXOs:input_type -> waverpc.RefreshCustomVTXOsRequest
	65,  // 91: waverpc.DaemonService.OpenVirtualChannel:input_type -> waverpc.OpenVirtualChannelRequest
	72,  // 92: waverpc.DaemonService.ListPendingForfeitParticipantSignatureRequests:input_type -> waverpc.ListPendingForfeitParticipantSignatureRequestsRequest
	75,  // 93: waverpc.DaemonService.SubmitForfeitParticipantSignatures:input_type -> waverpc.SubmitForfeitParticipantSignaturesRequest
	78,  // 94: waverpc.DaemonService.LeaveVTXOs:input_type -> waverpc.LeaveVTXOsRequest
	80,  // 95: waverpc.DaemonService.SendOnChain:input_type -> waverpc.SendOnChainRequest
	82,  // 96: waverpc.DaemonService.Board:input_type -> waverpc.BoardRequest
	84,  // 97: waverpc.DaemonService.JoinNextRound:input_type -> waverpc.JoinNextRoundRequest
	86,  // 98: waverpc.DaemonService.SweepBoardingUTXOs:input_type -> waverpc.SweepBoardingUTXOsRequest
	89,  // 99: waverpc.DaemonService.ListBoardingSweeps:input_type -> waverpc.ListBoardingSweepsRequest
	95,  // 100: waverpc.DaemonService.ListRounds:input_type -> waverpc.ListRoundsRequest
	96,  // 101: waverpc.DaemonService.GetRound:input_type -> waverpc.GetRoundRequest
	99,  // 102: waverpc.DaemonService.WatchRounds:input_type -> waverpc.WatchRoundsRequest
	102, // 103: waverpc.DaemonService.ListOORSessions:input_type -> waverpc.ListOORSessionsRequest
	104, // 104: waverpc.DaemonService.GetOORSession:input_type -> waverpc.GetOORSessionRequest
	106, // 105: waverpc.DaemonService.EstimateFee:input_type -> waverpc.EstimateFeeRequest
	108, // 106: waverpc.DaemonService.GetFeeHistory:input_type -> waverpc.GetFeeHistoryRequest
	111, // 107: waverpc.DaemonService.ListTransactions:input_type -> waverpc.ListTransactionsRequest
	114, // 108: waverpc.DaemonService.Unroll:input_type -> waverpc.UnrollRequest
	116, // 109: waverpc.DaemonService.GetUnrollStatus:input_type -> waverpc.GetUnrollStatusRequest
	121, // 110: waverpc.DaemonService.ArmVHTLCRecovery:input_type -> waverpc.ArmVHTLCRecoveryRequest
	123, // 111: waverpc.DaemonService.EscalateVHTLCRecovery:input_type -> waverpc.EscalateVHTLCRecoveryRequest
	125, // 112: waverpc.DaemonService.CancelVHTLCRecovery:input_type -> waverpc.CancelVHTLCRecoveryRequest
	127, // 113: waverpc.DaemonService.GetVHTLCRecoveryStatus:input_type -> waverpc.GetVHTLCRecoveryStatusRequest
	129, // 114: waverpc.DaemonService.ListVHTLCRecoveries:input_type -> waverpc.ListVHTLCRecoveriesRequest
	...
	70,  // 136: waverpc.DaemonService.RefreshCustomVTXOs:output_type -> waverpc.RefreshCustomVTXOsResponse
	66,  // 137: waverpc.DaemonService.OpenVirtualChannel:output_type -> waverpc.OpenVirtualChannelResponse
	73,  // 138: waverpc.DaemonService.ListPendingForfeitParticipantSignatureRequests:output_type -> waverpc.ListPendingForfeitParticipantSignatureRequestsResponse
	76,  // 139: waverpc.DaemonService.SubmitForfeitParticipantSignatures:output_type -> waverpc.SubmitForfeitParticipantSignaturesResponse
	79,  // 140: waverpc.DaemonService.LeaveVTXOs:output_type -> waverpc.LeaveVTXOsResponse
	81,  // 141: waverpc.DaemonService.SendOnChain:output_type -> waverpc.SendOnChainResponse
	83,  // 142: waverpc.DaemonService.Board:output_type -> waverpc.BoardResponse
	85,  // 143: waverpc.DaemonService.JoinNextRound:output_type -> waverpc.JoinNextRoundResponse
	88,  // 144: waverpc.DaemonService.SweepBoardingUTXOs:output_type -> waverpc.SweepBoardingUTXOsResponse
	92,  // 145: waverpc.DaemonService.ListBoardingSweeps:output_type -> waverpc.ListBoardingSweepsResponse
	98,  // 146: waverpc.DaemonService.ListRounds:output_type -> waverpc.ListRoundsResponse
	97,  // 147: waverpc.DaemonService.GetRound:output_type -> waverpc.GetRoundResponse
	100, // 148: waverpc.DaemonService.WatchRounds:output_type -> waverpc.WatchRoundsResponse
	103, // 149: waverpc.DaemonService.ListOORSessions:output_type -> waverpc.ListOORSessionsResponse
	105, // 150: waverpc.DaemonService.GetOORSession:output_type -> waverpc.GetOORSessionResponse
	107, // 151: waverpc.DaemonService.EstimateFee:output_type -> waverpc.EstimateFeeResponse
	110, // 152: waverpc.DaemonService.GetFeeHistory:output_type -> waverpc.GetFeeHistoryResponse
	113, // 153: waverpc.DaemonService.ListTransactions:output_type -> waverpc.ListTransactionsResponse
	115, // 154: waverpc.DaemonService.Unroll:output_type -> waverpc.UnrollResponse
	120, // 155: waverpc.DaemonService.GetUnrollStatus:output_type -> waverpc.GetUnrollStatusResponse
	122, // 156: waverpc.DaemonService.ArmVHTLCRecovery:output_type -> waverpc.ArmVHTLCRecoveryResponse
	124, // 157: waverpc.DaemonService.EscalateVHTLCRecovery:output_type -> waverpc.EscalateVHTLCRecoveryResponse
	126, // 158: waverpc.DaemonService.CancelVHTLCRecovery:output_type -> waverpc.CancelVHTLCRecoveryResponse
	128, // 159: waverpc.DaemonService.GetVHTLCRecoveryStatus:output_type -> waverpc.GetVHTLCRecoveryStatusResponse
	130, // 160: waverpc.DaemonService.ListVHTLCRecoveries:output_type -> waverpc.ListVHTLCRecoveriesResponse
