...
import (
	arkrpc "github.com/lightninglabs/wavelength/arkrpc"
	roundpb "github.com/lightninglabs/wavelength/rpc/roundpb"
...
type GetBatchScheduleRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetBatchScheduleRequest) Reset() {
	*x = GetBatchScheduleRequest{}
	mi := &file_daemon_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBatchScheduleRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBatchScheduleRequest) ProtoMessage() {}

func (x *GetBatchScheduleRequest) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use GetBatchScheduleRequest.ProtoReflect.Descriptor instead.
func (*GetBatchScheduleRequest) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{0}
}

type GetBatchScheduleResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// schedule is absent when the operator does not publish this capability.
	Schedule      *arkrpc.BatchScheduleInfo `protobuf:"bytes,1,opt,name=schedule,proto3" json:"schedule,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetBatchScheduleResponse) Reset() {
	*x = GetBatchScheduleResponse{}
	mi := &file_daemon_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBatchScheduleResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBatchScheduleResponse) ProtoMessage() {}

func (x *GetBatchScheduleResponse) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBatchScheduleResponse.ProtoReflect.Descriptor instead.
func (*GetBatchScheduleResponse) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{1}
}

func (x *GetBatchScheduleResponse) GetSchedule() *arkrpc.BatchScheduleInfo {
	if x != nil {
		return x.Schedule
	}
	return nil
...
type RefreshVTXOsRequest struct {
	...
	// service explicitly selects execution, expiry, and fee authorization.
	// Omit it to retain legacy round participation.
	Service       *roundpb.ServiceRequest `protobuf:"bytes,4,opt,name=service,proto3" json:"service,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RefreshVTXOsRequest) GetService() *roundpb.ServiceRequest {
	if x != nil {
		return x.Service
	}
	return nil
...
type LeaveVTXOsRequest struct {
	...
	// service explicitly selects execution, expiry, and fee authorization.
	// Omit it to retain legacy round participation.
	Service       *roundpb.ServiceRequest `protobuf:"bytes,6,opt,name=service,proto3" json:"service,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LeaveVTXOsRequest) GetService() *roundpb.ServiceRequest {
	if x != nil {
		return x.Service
	}
	return nil
...
type BoardRequest struct {
	...
	// service explicitly selects execution, expiry, and fee authorization.
	// Omit it to retain legacy round participation.
	Service       *roundpb.ServiceRequest `protobuf:"bytes,3,opt,name=service,proto3" json:"service,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BoardRequest) GetService() *roundpb.ServiceRequest {
	if x != nil {
		return x.Service
	}
	return nil
...
type RoundInfo struct {
	...
	FailureReason string `protobuf:"bytes,11,opt,name=failure_reason,json=failureReason,proto3" json:"failure_reason,omitempty"`
	// admission is the latest typed service assignment or rejection observed
	// by the live client. It is not proof of a remote terminal outcome.
	Admission *roundpb.ServiceAdmission `protobuf:"bytes,12,opt,name=admission,proto3" json:"admission,omitempty"`
	// Latest authenticated ownership report observed by the live client.
	// Absence means no report has been observed, not that ownership is free.
	Operation     *roundpb.OperationStatus `protobuf:"bytes,13,opt,name=operation,proto3" json:"operation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RoundInfo) GetAdmission() *roundpb.ServiceAdmission {
	if x != nil {
		return x.Admission
	}
	return nil
...
func (x *RoundInfo) GetOperation() *roundpb.OperationStatus {
	if x != nil {
		return x.Operation
	}
	return nil
...
const file_daemon_proto_rawDesc = "" +
	"\n" +
	"\fdaemon.proto\x12\awaverpc\x1a\x17rpc/roundpb/round.proto\x1a\x10arkrpc/ark.proto\"\x19\n" +
	"\x17GetBatchScheduleRequest\"Q\n" +
	"\x18GetBatchScheduleResponse\x125\n" +
	"\bschedule\x18\x01 \x01(\v2\x19.arkrpc.BatchScheduleInfoR\bschedule\"\x10\n" +
	...
	"\toutpoints\x18\x01 \x03(\tR\toutpoints\"\xbf\x01\n" +
	...
	"\adry_run\x18\x03 \x01(\bR\x06dryRun\x122\n" +
	"\aservice\x18\x04 \x01(\v2\x18.round.v1.ServiceRequestR\aserviceB\v\n" +
	"\tselection\"\x99\x01\n" +
	...
	"\adry_run\x18\x05 \x01(\bR\x06dryRun\x122\n" +
	"\aservice\x18\x06 \x01(\v2\x18.round.v1.ServiceRequestR\aservice\x1aZ\n" +
	...
	"\vsend_job_id\x18\x06 \x01(\tR\tsendJobId\"\x8d\x01\n" +
	"\fBoardRequest\x12*\n" +
	"\x11target_vtxo_count\x18\x01 \x01(\rR\x0ftargetVtxoCount\x12\x1d\n" +
	"\n" +
	"no_persist\x18\x02 \x01(\bR\tnoPersist\x122\n" +
	"\aservice\x18\x03 \x01(\v2\x18.round.v1.ServiceRequestR\aservice\"F\n" +
	...
	"\boutpoint\x18\x01 \x01(\tR\boutpoint\x12\x1d\n" +
	"\n" +
	"amount_sat\x18\x02 \x01(\x03R\tamountSat\"\xab\x04\n" +
	"\tRoundInfo\x12\x19\n" +
	...
	"\x0efailure_reason\x18\v \x01(\tR\rfailureReason\x128\n" +
	"\tadmission\x18\f \x01(\v2\x1a.round.v1.ServiceAdmissionR\tadmission\x127\n" +
	"\toperation\x18\r \x01(\v2\x19.round.v1.OperationStatusR\toperation\"\xfa\x01\n" +
	...
	"\x12\x1f\n" +
	"\x1bVHTLC_RECOVERY_STATE_FAILED\x10\v2\x8e!\n" +
	"\rDaemonService\x12<\n" +
	"\aGetInfo\x12\x17.waverpc.GetInfoRequest\x1a\x18.waverpc.GetInfoResponse\x12W\n" +
	"\x10GetBatchSchedule\x12 .waverpc.GetBatchScheduleRequest\x1a!.waverpc.GetBatchScheduleResponse\x12<\n" +
...
var file_daemon_proto_goTypes = []any{
	...
	(*GetBatchScheduleRequest)(nil),                                // 11: waverpc.GetBatchScheduleRequest
	(*GetBatchScheduleResponse)(nil),                               // 12: waverpc.GetBatchScheduleResponse
	...
	(*VTXOSettlement)(nil),                                         // 26: waverpc.VTXOSettlement
	(*ListVTXOsRequest)(nil),                                       // 27: waverpc.ListVTXOsRequest
	(*ListVTXOsResponse)(nil),                                      // 28: waverpc.ListVTXOsResponse
	(*NewAddressRequest)(nil),                                      // 29: waverpc.NewAddressRequest
	(*NewAddressResponse)(nil),                                     // 30: waverpc.NewAddressResponse
	(*NewReceiveScriptRequest)(nil),                                // 31: waverpc.NewReceiveScriptRequest
	(*NewReceiveScriptResponse)(nil),                               // 32: waverpc.NewReceiveScriptResponse
	(*ReceiveAuthKeyRequest)(nil),                                  // 33: waverpc.ReceiveAuthKeyRequest
	(*ReceiveAuthKeyResponse)(nil),                                 // 34: waverpc.ReceiveAuthKeyResponse
	(*SignReceiveAuthMessageRequest)(nil),                          // 35: waverpc.SignReceiveAuthMessageRequest
	(*SignReceiveAuthMessageResponse)(nil),                         // 36: waverpc.SignReceiveAuthMessageResponse
	(*SignReceiveAuthMessageCompactRequest)(nil),                   // 37: waverpc.SignReceiveAuthMessageCompactRequest
	(*SignReceiveAuthMessageCompactResponse)(nil),                  // 38: waverpc.SignReceiveAuthMessageCompactResponse
	(*ReceiveAuthECDHRequest)(nil),                                 // 39: waverpc.ReceiveAuthECDHRequest
	(*ReceiveAuthECDHResponse)(nil),                                // 40: waverpc.ReceiveAuthECDHResponse
	(*GetIndexedVTXOByPkScriptRequest)(nil),                        // 41: waverpc.GetIndexedVTXOByPkScriptRequest
	(*GetIndexedVTXOByPkScriptResponse)(nil),                       // 42: waverpc.GetIndexedVTXOByPkScriptResponse
	(*GetVTXOExpiryInfoRequest)(nil),                               // 43: waverpc.GetVTXOExpiryInfoRequest
	(*GetVTXOExpiryInfoResponse)(nil),                              // 44: waverpc.GetVTXOExpiryInfoResponse
	(*GetIndexedOORSessionByTxidRequest)(nil),                      // 45: waverpc.GetIndexedOORSessionByTxidRequest
	(*GetIndexedOORSessionByTxidResponse)(nil),                     // 46: waverpc.GetIndexedOORSessionByTxidResponse
	(*Output)(nil),                                                 // 47: waverpc.Output
	(*SendVTXORequest)(nil),                                        // 48: waverpc.SendVTXORequest
	(*SendVTXOResponse)(nil),                                       // 49: waverpc.SendVTXOResponse
	(*SendOORRequest)(nil),                                         // 50: waverpc.SendOORRequest
	(*CustomOORInput)(nil),                                         // 51: waverpc.CustomOORInput
	(*TaprootScriptSignature)(nil),                                 // 52: waverpc.TaprootScriptSignature
	(*SendOORResponse)(nil),                                        // 53: waverpc.SendOORResponse
	(*PrepareOORRequest)(nil),                                      // 54: waverpc.PrepareOORRequest
	(*PreparedOORCustomInput)(nil),                                 // 55: waverpc.PreparedOORCustomInput
	(*PrepareOORResponse)(nil),                                     // 56: waverpc.PrepareOORResponse
	(*SignOORCustomInputRequest)(nil),                              // 57: waverpc.SignOORCustomInputRequest
	(*SignOORCustomInputResponse)(nil),                             // 58: waverpc.SignOORCustomInputResponse
	(*SignVTXOForfeitRequest)(nil),                                 // 59: waverpc.SignVTXOForfeitRequest
	(*SignVTXOForfeitResponse)(nil),                                // 60: waverpc.SignVTXOForfeitResponse
	(*ForfeitSigningContext)(nil),                                  // 61: waverpc.ForfeitSigningContext
	(*OutpointSelection)(nil),                                      // 62: waverpc.OutpointSelection
	(*RefreshVTXOsRequest)(nil),                                    // 63: waverpc.RefreshVTXOsRequest
	(*RefreshVTXOsResponse)(nil),                                   // 64: waverpc.RefreshVTXOsResponse
	(*RefreshFeeEstimate)(nil),                                     // 65: waverpc.RefreshFeeEstimate
	(*OutpointFeeEstimate)(nil),                                    // 66: waverpc.OutpointFeeEstimate
	(*CustomRefreshVTXOInput)(nil),                                 // 67: waverpc.CustomRefreshVTXOInput
	(*CustomRefreshVTXOOutput)(nil),                                // 68: waverpc.CustomRefreshVTXOOutput
	(*RefreshCustomVTXOsRequest)(nil),                              // 69: waverpc.RefreshCustomVTXOsRequest
	(*RefreshCustomVTXOsResponse)(nil),                             // 70: waverpc.RefreshCustomVTXOsResponse
	(*PendingForfeitParticipantSignatureRequest)(nil),              // 71: waverpc.PendingForfeitParticipantSignatureRequest
	(*ListPendingForfeitParticipantSignatureRequestsRequest)(nil),  // 72: waverpc.ListPendingForfeitParticipantSignatureRequestsRequest
	(*ListPendingForfeitParticipantSignatureRequestsResponse)(nil), // 73: waverpc.ListPendingForfeitParticipantSignatureRequestsResponse
	(*ForfeitParticipantSignature)(nil),                            // 74: waverpc.ForfeitParticipantSignature
	(*SubmitForfeitParticipantSignaturesRequest)(nil),              // 75: waverpc.SubmitForfeitParticipantSignaturesRequest
	(*SubmitForfeitParticipantSignaturesResponse)(nil),             // 76: waverpc.SubmitForfeitParticipantSignaturesResponse
	(*LeaveDestination)(nil),                                       // 77: waverpc.LeaveDestination
	(*LeaveVTXOsRequest)(nil),                                      // 78: waverpc.LeaveVTXOsRequest
	(*LeaveVTXOsResponse)(nil),                                     // 79: waverpc.LeaveVTXOsResponse
	(*SendOnChainRequest)(nil),                                     // 80: waverpc.SendOnChainRequest
	(*SendOnChainResponse)(nil),                                    // 81: waverpc.SendOnChainResponse
	(*BoardRequest)(nil),                                           // 82: waverpc.BoardRequest
	(*BoardResponse)(nil),                                          // 83: waverpc.BoardResponse
	(*JoinNextRoundRequest)(nil),                                   // 84: waverpc.JoinNextRoundRequest
	(*JoinNextRoundResponse)(nil),                                  // 85: waverpc.JoinNextRoundResponse
	(*SweepBoardingUTXOsRequest)(nil),                              // 86: waverpc.SweepBoardingUTXOsRequest
	(*BoardingSweepOutput)(nil),                                    // 87: waverpc.BoardingSweepOutput
	(*SweepBoardingUTXOsResponse)(nil),                             // 88: waverpc.SweepBoardingUTXOsResponse
	(*ListBoardingSweepsRequest)(nil),                              // 89: waverpc.ListBoardingSweepsRequest
	(*BoardingSweepInput)(nil),                                     // 90: waverpc.BoardingSweepInput
	(*BoardingSweep)(nil),                                          // 91: waverpc.BoardingSweep
	(*ListBoardingSweepsResponse)(nil),                             // 92: waverpc.ListBoardingSweepsResponse
	(*RoundVTXOInfo)(nil),                                          // 93: waverpc.RoundVTXOInfo
	(*RoundInfo)(nil),                                              // 94: waverpc.RoundInfo
	(*ListRoundsRequest)(nil),                                      // 95: waverpc.ListRoundsRequest
	(*GetRoundRequest)(nil),                                        // 96: waverpc.GetRoundRequest
	(*GetRoundResponse)(nil),                                       // 97: waverpc.GetRoundResponse
	(*ListRoundsResponse)(nil),                                     // 98: waverpc.ListRoundsResponse
	(*WatchRoundsRequest)(nil),                                     // 99: waverpc.WatchRoundsRequest
	(*WatchRoundsResponse)(nil),                                    // 100: waverpc.WatchRoundsResponse
	(*OORSessionInfo)(nil),                                         // 101: waverpc.OORSessionInfo
	(*ListOORSessionsRequest)(nil),                                 // 102: waverpc.ListOORSessionsRequest
	(*ListOORSessionsResponse)(nil),                                // 103: waverpc.ListOORSessionsResponse
	(*GetOORSessionRequest)(nil),                                   // 104: waverpc.GetOORSessionRequest
	(*GetOORSessionResponse)(nil),                                  // 105: waverpc.GetOORSessionResponse
	(*EstimateFeeRequest)(nil),                                     // 106: waverpc.EstimateFeeRequest
	(*EstimateFeeResponse)(nil),                                    // 107: waverpc.EstimateFeeResponse
	(*GetFeeHistoryRequest)(nil),                                   // 108: waverpc.GetFeeHistoryRequest
	(*FeeHistoryEntry)(nil),                                        // 109: waverpc.FeeHistoryEntry
	(*GetFeeHistoryResponse)(nil),                                  // 110: waverpc.GetFeeHistoryResponse
	(*ListTransactionsRequest)(nil),                                // 111: waverpc.ListTransactionsRequest
	(*TransactionHistoryEntry)(nil),                                // 112: waverpc.TransactionHistoryEntry
	(*ListTransactionsResponse)(nil),                               // 113: waverpc.ListTransactionsResponse
	(*UnrollRequest)(nil),                                          // 114: waverpc.UnrollRequest
	(*UnrollResponse)(nil),                                         // 115: waverpc.UnrollResponse
	(*GetUnrollStatusRequest)(nil),                                 // 116: waverpc.GetUnrollStatusRequest
	(*UnrollProgress)(nil),                                         // 117: waverpc.UnrollProgress
	(*UnrollCSV)(nil),                                              // 118: waverpc.UnrollCSV
	(*UnrollFees)(nil),                                             // 119: waverpc.UnrollFees
	(*GetUnrollStatusResponse)(nil),                                // 120: waverpc.GetUnrollStatusResponse
	(*ArmVHTLCRecoveryRequest)(nil),                                // 121: waverpc.ArmVHTLCRecoveryRequest
	(*ArmVHTLCRecoveryResponse)(nil),                               // 122: waverpc.ArmVHTLCRecoveryResponse
	(*EscalateVHTLCRecoveryRequest)(nil),                           // 123: waverpc.EscalateVHTLCRecoveryRequest
	(*EscalateVHTLCRecoveryResponse)(nil),                          // 124: waverpc.EscalateVHTLCRecoveryResponse
	(*CancelVHTLCRecoveryRequest)(nil),                             // 125: waverpc.CancelVHTLCRecoveryRequest
	(*CancelVHTLCRecoveryResponse)(nil),                            // 126: waverpc.CancelVHTLCRecoveryResponse
	(*GetVHTLCRecoveryStatusRequest)(nil),                          // 127: waverpc.GetVHTLCRecoveryStatusRequest
	(*GetVHTLCRecoveryStatusResponse)(nil),                         // 128: waverpc.GetVHTLCRecoveryStatusResponse
	(*ListVHTLCRecoveriesRequest)(nil),                             // 129: waverpc.ListVHTLCRecoveriesRequest
	(*ListVHTLCRecoveriesResponse)(nil),                            // 130: waverpc.ListVHTLCRecoveriesResponse
	(*VHTLCRecoveryStatus)(nil),                                    // 131: waverpc.VHTLCRecoveryStatus
	(*SignOutSwapHtlcAckRequest)(nil),                              // 132: waverpc.SignOutSwapHtlcAckRequest
	(*SignOutSwapHtlcAckResponse)(nil),                             // 133: waverpc.SignOutSwapHtlcAckResponse
	(*SignCreditAccountAuthorizationRequest)(nil),                  // 134: waverpc.SignCreditAccountAuthorizationRequest
	(*SignCreditAccountAuthorizationResponse)(nil),                 // 135: waverpc.SignCreditAccountAuthorizationResponse
	(*MacaroonPermission)(nil),                                     // 136: waverpc.MacaroonPermission
	(*BakeMacaroonRequest)(nil),                                    // 137: waverpc.BakeMacaroonRequest
	(*BakeMacaroonResponse)(nil),                                   // 138: waverpc.BakeMacaroonResponse
	(*MacaroonPermissionList)(nil),                                 // 139: waverpc.MacaroonPermissionList
	(*ListPermissionsRequest)(nil),                                 // 140: waverpc.ListPermissionsRequest
	(*ListPermissionsResponse)(nil),                                // 141: waverpc.ListPermissionsResponse
	nil,                                                            // 142: waverpc.LeaveVTXOsRequest.DestinationsEntry
	nil,                                                            // 143: waverpc.ListPermissionsResponse.MethodPermissionsEntry
	(*arkrpc.BatchScheduleInfo)(nil),                               // 144: arkrpc.BatchScheduleInfo
	(*roundpb.ServiceRequest)(nil),                                 // 145: round.v1.ServiceRequest
	(*roundpb.ServiceAdmission)(nil),                               // 146: round.v1.ServiceAdmission
	(*roundpb.OperationStatus)(nil),                                // 147: round.v1.OperationStatus
}
var file_daemon_proto_depIdxs = []int32{
	144, // 0: waverpc.GetBatchScheduleResponse.schedule:type_name -> arkrpc.BatchScheduleInfo
	0,   // 1: waverpc.GetInfoResponse.wallet_state:type_name -> waverpc.WalletState
	15,  // 2: waverpc.GetInfoResponse.server_info:type_name -> waverpc.ServerInfo
	2,   // 3: waverpc.VTXOExpiryInfo.status:type_name -> waverpc.VTXOExpiryStatus
	1,   // 4: waverpc.VTXO.status:type_name -> waverpc.VTXOStatus
	24,  // 5: waverpc.VTXO.expiry_info:type_name -> waverpc.VTXOExpiryInfo
	26,  // 6: waverpc.VTXO.settlement:type_name -> waverpc.VTXOSettlement
	...
	25,  // 9: waverpc.ListVTXOsResponse.vtxos:type_name -> waverpc.VTXO
	1,   // 10: waverpc.GetIndexedVTXOByPkScriptRequest.status_filter:type_name -> waverpc.VTXOStatus
	25,  // 11: waverpc.GetIndexedVTXOByPkScriptResponse.vtxo:type_name -> waverpc.VTXO
	1,   // 12: waverpc.GetVTXOExpiryInfoRequest.status_filter:type_name -> waverpc.VTXOStatus
	24,  // 13: waverpc.GetVTXOExpiryInfoResponse.expiry_info:type_name -> waverpc.VTXOExpiryInfo
	25,  // 14: waverpc.GetVTXOExpiryInfoResponse.vtxo:type_name -> waverpc.VTXO
	47,  // 15: waverpc.SendVTXORequest.recipients:type_name -> waverpc.Output
	47,  // 16: waverpc.SendOORRequest.recipients:type_name -> waverpc.Output
	51,  // 17: waverpc.SendOORRequest.custom_inputs:type_name -> waverpc.CustomOORInput
	52,  // 18: waverpc.CustomOORInput.external_signatures:type_name -> waverpc.TaprootScriptSignature
	47,  // 19: waverpc.PrepareOORRequest.recipient:type_name -> waverpc.Output
	51,  // 20: waverpc.PrepareOORRequest.custom_inputs:type_name -> waverpc.CustomOORInput
	55,  // 21: waverpc.PrepareOORResponse.custom_inputs:type_name -> waverpc.PreparedOORCustomInput
	51,  // 22: waverpc.SignOORCustomInputRequest.custom_input:type_name -> waverpc.CustomOORInput
	52,  // 23: waverpc.SignOORCustomInputResponse.signature:type_name -> waverpc.TaprootScriptSignature
	3,   // 24: waverpc.ForfeitSigningContext.signing_route:type_name -> waverpc.ForfeitSigningRoute
	62,  // 25: waverpc.RefreshVTXOsRequest.outpoints:type_name -> waverpc.OutpointSelection
	145, // 26: waverpc.RefreshVTXOsRequest.service:type_name -> round.v1.ServiceRequest
	65,  // 27: waverpc.RefreshVTXOsResponse.fee_estimate:type_name -> waverpc.RefreshFeeEstimate
	66,  // 28: waverpc.RefreshFeeEstimate.outpoints:type_name -> waverpc.OutpointFeeEstimate
	61,  // 29: waverpc.CustomRefreshVTXOInput.forfeit_signing_context:type_name -> waverpc.ForfeitSigningContext
	67,  // 30: waverpc.RefreshCustomVTXOsRequest.inputs:type_name -> waverpc.CustomRefreshVTXOInput
	68,  // 31: waverpc.RefreshCustomVTXOsRequest.outputs:type_name -> waverpc.CustomRefreshVTXOOutput
	3,   // 32: waverpc.PendingForfeitParticipantSignatureRequest.signing_route:type_name -> waverpc.ForfeitSigningRoute
	71,  // 33: waverpc.ListPendingForfeitParticipantSignatureRequestsResponse.requests:type_name -> waverpc.PendingForfeitParticipantSignatureRequest
	74,  // 34: waverpc.SubmitForfeitParticipantSignaturesRequest.signatures:type_name -> waverpc.ForfeitParticipantSignature
	62,  // 35: waverpc.LeaveVTXOsRequest.outpoints:type_name -> waverpc.OutpointSelection
	77,  // 36: waverpc.LeaveVTXOsRequest.default_destination:type_name -> waverpc.LeaveDestination
	142, // 37: waverpc.LeaveVTXOsRequest.destinations:type_name -> waverpc.LeaveVTXOsRequest.DestinationsEntry
	145, // 38: waverpc.LeaveVTXOsRequest.service:type_name -> round.v1.ServiceRequest
	77,  // 39: waverpc.SendOnChainRequest.destination:type_name -> waverpc.LeaveDestination
	145, // 40: waverpc.BoardRequest.service:type_name -> round.v1.ServiceRequest
	87,  // 41: waverpc.SweepBoardingUTXOsResponse.sweepable_outputs:type_name -> waverpc.BoardingSweepOutput
	90,  // 42: waverpc.BoardingSweep.inputs:type_name -> waverpc.BoardingSweepInput
	91,  // 43: waverpc.ListBoardingSweepsResponse.sweeps:type_name -> waverpc.BoardingSweep
	4,   // 44: waverpc.RoundInfo.state:type_name -> waverpc.RoundState
	93,  // 45: waverpc.RoundInfo.vtxos:type_name -> waverpc.RoundVTXOInfo
	146, // 46: waverpc.RoundInfo.admission:type_name -> round.v1.ServiceAdmission
	147, // 47: waverpc.RoundInfo.operation:type_name -> round.v1.OperationStatus
	4,   // 48: waverpc.ListRoundsRequest.state_filter:type_name -> waverpc.RoundState
	94,  // 49: waverpc.GetRoundResponse.round:type_name -> waverpc.RoundInfo
	94,  // 50: waverpc.ListRoundsResponse.rounds:type_name -> waverpc.RoundInfo
	94,  // 51: waverpc.WatchRoundsResponse.round:type_name -> waverpc.RoundInfo
	5,   // 52: waverpc.OORSessionInfo.direction:type_name -> waverpc.OORSessionDirection
	6,   // 53: waverpc.OORSessionInfo.status:type_name -> waverpc.OORSessionStatus
	5,   // 54: waverpc.ListOORSessionsRequest.direction_filter:type_name -> waverpc.OORSessionDirection
	6,   // 55: waverpc.ListOORSessionsRequest.status_filter:type_name -> waverpc.OORSessionStatus
	101, // 56: waverpc.ListOORSessionsResponse.sessions:type_name -> waverpc.OORSessionInfo
	101, // 57: waverpc.GetOORSessionResponse.session:type_name -> waverpc.OORSessionInfo
	109, // 58: waverpc.GetFeeHistoryResponse.entries:type_name -> waverpc.FeeHistoryEntry
	112, // 59: waverpc.ListTransactionsResponse.transactions:type_name -> waverpc.TransactionHistoryEntry
	7,   // 60: waverpc.GetUnrollStatusResponse.status:type_name -> waverpc.UnrollJobStatus
	117, // 61: waverpc.GetUnrollStatusResponse.progress:type_name -> waverpc.UnrollProgress
	118, // 62: waverpc.GetUnrollStatusResponse.csv:type_name -> waverpc.UnrollCSV
	119, // 63: waverpc.GetUnrollStatusResponse.fees:type_name -> waverpc.UnrollFees
	8,   // 64: waverpc.ArmVHTLCRecoveryRequest.direction:type_name -> waverpc.VHTLCRecoveryDirection
	9,   // 65: waverpc.ArmVHTLCRecoveryRequest.action:type_name -> waverpc.VHTLCRecoveryAction
	131, // 66: waverpc.ArmVHTLCRecoveryResponse.status:type_name -> waverpc.VHTLCRecoveryStatus
	131, // 67: waverpc.EscalateVHTLCRecoveryResponse.status:type_name -> waverpc.VHTLCRecoveryStatus
	131, // 68: waverpc.CancelVHTLCRecoveryResponse.status:type_name -> waverpc.VHTLCRecoveryStatus
	131, // 69: waverpc.GetVHTLCRecoveryStatusResponse.status:type_name -> waverpc.VHTLCRecoveryStatus
	131, // 70: waverpc.ListVHTLCRecoveriesResponse.statuses:type_name -> waverpc.VHTLCRecoveryStatus
	8,   // 71: waverpc.VHTLCRecoveryStatus.direction:type_name -> waverpc.VHTLCRecoveryDirection
	9,   // 72: waverpc.VHTLCRecoveryStatus.action:type_name -> waverpc.VHTLCRecoveryAction
	10,  // 73: waverpc.VHTLCRecoveryStatus.state:type_name -> waverpc.VHTLCRecoveryState
	7,   // 74: waverpc.VHTLCRecoveryStatus.unroll_status:type_name -> waverpc.UnrollJobStatus
	136, // 75: waverpc.BakeMacaroonRequest.permissions:type_name -> waverpc.MacaroonPermission
	136, // 76: waverpc.MacaroonPermissionList.permissions:type_name -> waverpc.MacaroonPermission
	143, // 77: waverpc.ListPermissionsResponse.method_permissions:type_name -> waverpc.ListPermissionsResponse.MethodPermissionsEntry
	77,  // 78: waverpc.LeaveVTXOsRequest.DestinationsEntry.value:type_name -> waverpc.LeaveDestination
	139, // 79: waverpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> waverpc.MacaroonPermissionList
	13,  // 80: waverpc.DaemonService.GetInfo:input_type -> waverpc.GetInfoRequest
	11,  // 81: waverpc.DaemonService.GetBatchSchedule:input_type -> waverpc.GetBatchScheduleRequest
	16,  // 82: waverpc.DaemonService.GenSeed:input_type -> waverpc.GenSeedRequest
	18,  // 83: waverpc.DaemonService.InitWallet:input_type -> waverpc.InitWalletRequest
	20,  // 84: waverpc.DaemonService.UnlockWallet:input_type -> waverpc.UnlockWalletRequest
	22,  // 85: waverpc.DaemonService.GetBalance:input_type -> waverpc.GetBalanceRequest
	27,  // 86: waverpc.DaemonService.ListVTXOs:input_type -> waverpc.ListVTXOsRequest
	29,  // 87: waverpc.DaemonService.NewAddress:input_type -> waverpc.NewAddressRequest
	31,  // 88: waverpc.DaemonService.NewReceiveScript:input_type -> waverpc.NewReceiveScriptRequest
	33,  // 89: waverpc.DaemonService.ReceiveAuthKey:input_type -> waverpc.ReceiveAuthKeyRequest
	35,  // 90: waverpc.DaemonService.SignReceiveAuthMessage:input_type -> waverpc.SignReceiveAuthMessageRequest
	37,  // 91: waverpc.DaemonService.SignReceiveAuthMessageCompact:input_type -> waverpc.SignReceiveAuthMessageCompactRequest
	39,  // 92: waverpc.DaemonService.ReceiveAuthECDH:input_type -> waverpc.ReceiveAuthECDHRequest
	41,  // 93: waverpc.DaemonService.GetIndexedVTXOByPkScript:input_type -> waverpc.GetIndexedVTXOByPkScriptRequest
	43,  // 94: waverpc.DaemonService.GetVTXOExpiryInfo:input_type -> waverpc.GetVTXOExpiryInfoRequest
	45,  // 95: waverpc.DaemonService.GetIndexedOORSessionByTxid:input_type -> waverpc.GetIndexedOORSessionByTxidRequest
	48,  // 96: waverpc.DaemonService.SendVTXO:input_type -> waverpc.SendVTXORequest
	50,  // 97: waverpc.DaemonService.SendOOR:input_type -> waverpc.SendOORRequest
	54,  // 98: waverpc.DaemonService.PrepareOOR:input_type -> waverpc.PrepareOORRequest
	57,  // 99: waverpc.DaemonService.SignOORCustomInput:input_type -> waverpc.SignOORCustomInputRequest
	59,  // 100: waverpc.DaemonService.SignVTXOForfeit:input_type -> waverpc.SignVTXOForfeitRequest
	63,  // 101: waverpc.DaemonService.RefreshVTXOs:input_type -> waverpc.RefreshVTXOsRequest
	69,  // 102: waverpc.DaemonService.RefreshCustomVTXOs:input_type -> waverpc.RefreshCustomVTXOsRequest
	72,  // 103: waverpc.DaemonService.ListPendingForfeitParticipantSignatureRequests:input_type -> waverpc.ListPendingForfeitParticipantSignatureRequestsRequest
	75,  // 104: waverpc.DaemonService.SubmitForfeitParticipantSignatures:input_type -> waverpc.SubmitForfeitParticipantSignaturesRequest
	78,  // 105: waverpc.DaemonService.LeaveVTXOs:input_type -> waverpc.LeaveVTXOsRequest
	80,  // 106: waverpc.DaemonService.SendOnChain:input_type -> waverpc.SendOnChainRequest
	82,  // 107: waverpc.DaemonService.Board:input_type -> waverpc.BoardRequest
	84,  // 108: waverpc.DaemonService.JoinNextRound:input_type -> waverpc.JoinNextRoundRequest
	86,  // 109: waverpc.DaemonService.SweepBoardingUTXOs:input_type -> waverpc.SweepBoardingUTXOsRequest
	89,  // 110: waverpc.DaemonService.ListBoardingSweeps:input_type -> waverpc.ListBoardingSweepsRequest
	95,  // 111: waverpc.DaemonService.ListRounds:input_type -> waverpc.ListRoundsRequest
	96,  // 112: waverpc.DaemonService.GetRound:input_type -> waverpc.GetRoundRequest
	99,  // 113: waverpc.DaemonService.WatchRounds:input_type -> waverpc.WatchRoundsRequest
	102, // 114: waverpc.DaemonService.ListOORSessions:input_type -> waverpc.ListOORSessionsRequest
	104, // 115: waverpc.DaemonService.GetOORSession:input_type -> waverpc.GetOORSessionRequest
	106, // 116: waverpc.DaemonService.EstimateFee:input_type -> waverpc.EstimateFeeRequest
	108, // 117: waverpc.DaemonService.GetFeeHistory:input_type -> waverpc.GetFeeHistoryRequest
	111, // 118: waverpc.DaemonService.ListTransactions:input_type -> waverpc.ListTransactionsRequest
	114, // 119: waverpc.DaemonService.Unroll:input_type -> waverpc.UnrollRequest
	116, // 120: waverpc.DaemonService.GetUnrollStatus:input_type -> waverpc.GetUnrollStatusRequest
	121, // 121: waverpc.DaemonService.ArmVHTLCRecovery:input_type -> waverpc.ArmVHTLCRecoveryRequest
	123, // 122: waverpc.DaemonService.EscalateVHTLCRecovery:input_type -> waverpc.EscalateVHTLCRecoveryRequest
	125, // 123: waverpc.DaemonService.CancelVHTLCRecovery:input_type -> waverpc.CancelVHTLCRecoveryRequest
	127, // 124: waverpc.DaemonService.GetVHTLCRecoveryStatus:input_type -> waverpc.GetVHTLCRecoveryStatusRequest
	129, // 125: waverpc.DaemonService.ListVHTLCRecoveries:input_type -> waverpc.ListVHTLCRecoveriesRequest
	132, // 126: waverpc.DaemonService.SignOutSwapHtlcAck:input_type -> waverpc.SignOutSwapHtlcAckRequest
	134, // 127: waverpc.DaemonService.SignCreditAccountAuthorization:input_type -> waverpc.SignCreditAccountAuthorizationRequest
	137, // 128: waverpc.MacaroonService.BakeMacaroon:input_type -> waverpc.BakeMacaroonRequest
	140, // 129: waverpc.MacaroonService.ListPermissions:input_type -> waverpc.ListPermissionsRequest
	14,  // 130: waverpc.DaemonService.GetInfo:output_type -> waverpc.GetInfoResponse
	12,  // 131: waverpc.DaemonService.GetBatchSchedule:output_type -> waverpc.GetBatchScheduleResponse
	17,  // 132: waverpc.DaemonService.GenSeed:output_type -> waverpc.GenSeedResponse
	19,  // 133: waverpc.DaemonService.InitWallet:output_type -> waverpc.InitWalletResponse
	21,  // 134: waverpc.DaemonService.UnlockWallet:output_type -> waverpc.UnlockWalletResponse
	23,  // 135: waverpc.DaemonService.GetBalance:output_type -> waverpc.GetBalanceResponse
	28,  // 136: waverpc.DaemonService.ListVTXOs:output_type -> waverpc.ListVTXOsResponse
	30,  // 137: waverpc.DaemonService.NewAddress:output_type -> waverpc.NewAddressResponse
	32,  // 138: waverpc.DaemonService.NewReceiveScript:output_type -> waverpc.NewReceiveScriptResponse
	34,  // 139: waverpc.DaemonService.ReceiveAuthKey:output_type -> waverpc.ReceiveAuthKeyResponse
	36,  // 140: waverpc.DaemonService.SignReceiveAuthMessage:output_type -> waverpc.SignReceiveAuthMessageResponse
	38,  // 141: waverpc.DaemonService.SignReceiveAuthMessageCompact:output_type -> waverpc.SignReceiveAuthMessageCompactResponse
	40,  // 142: waverpc.DaemonService.ReceiveAuthECDH:output_type -> waverpc.ReceiveAuthECDHResponse
	42,  // 143: waverpc.DaemonService.GetIndexedVTXOByPkScript:output_type -> waverpc.GetIndexedVTXOByPkScriptResponse
	44,  // 144: waverpc.DaemonService.GetVTXOExpiryInfo:output_type -> waverpc.GetVTXOExpiryInfoResponse
	46,  // 145: waverpc.DaemonService.GetIndexedOORSessionByTxid:output_type -> waverpc.GetIndexedOORSessionByTxidResponse
	49,  // 146: waverpc.DaemonService.SendVTXO:output_type -> waverpc.SendVTXOResponse
	53,  // 147: waverpc.DaemonService.SendOOR:output_type -> waverpc.SendOORResponse
	56,  // 148: waverpc.DaemonService.PrepareOOR:output_type -> waverpc.PrepareOORResponse
	58,  // 149: waverpc.DaemonService.SignOORCustomInput:output_type -> waverpc.SignOORCustomInputResponse
	60,  // 150: waverpc.DaemonService.SignVTXOForfeit:output_type -> waverpc.SignVTXOForfeitResponse
	64,  // 151: waverpc.DaemonService.RefreshVTXOs:output_type -> waverpc.RefreshVTXOsResponse
	70,  // 152: waverpc.DaemonService.RefreshCustomVTXOs:output_type -> waverpc.RefreshCustomVTXOsResponse
	73,  // 153: waverpc.DaemonService.ListPendingForfeitParticipantSignatureRequests:output_type -> waverpc.ListPendingForfeitParticipantSignatureRequestsResponse
	76,  // 154: waverpc.DaemonService.SubmitForfeitParticipantSignatures:output_type -> waverpc.SubmitForfeitParticipantSignaturesResponse
	79,  // 155: waverpc.DaemonService.LeaveVTXOs:output_type -> waverpc.LeaveVTXOsResponse
	81,  // 156: waverpc.DaemonService.SendOnChain:output_type -> waverpc.SendOnChainResponse
	83,  // 157: waverpc.DaemonService.Board:output_type -> waverpc.BoardResponse
	85,  // 158: waverpc.DaemonService.JoinNextRound:output_type -> waverpc.JoinNextRoundResponse
	88,  // 159: waverpc.DaemonService.SweepBoardingUTXOs:output_type -> waverpc.SweepBoardingUTXOsResponse
	92,  // 160: waverpc.DaemonService.ListBoardingSweeps:output_type -> waverpc.ListBoardingSweepsResponse
	98,  // 161: waverpc.DaemonService.ListRounds:output_type -> waverpc.ListRoundsResponse
	97,  // 162: waverpc.DaemonService.GetRound:output_type -> waverpc.GetRoundResponse
	100, // 163: waverpc.DaemonService.WatchRounds:output_type -> waverpc.WatchRoundsResponse
	103, // 164: waverpc.DaemonService.ListOORSessions:output_type -> waverpc.ListOORSessionsResponse
	105, // 165: waverpc.DaemonService.GetOORSession:output_type -> waverpc.GetOORSessionResponse
	107, // 166: waverpc.DaemonService.EstimateFee:output_type -> waverpc.EstimateFeeResponse
	110, // 167: waverpc.DaemonService.GetFeeHistory:output_type -> waverpc.GetFeeHistoryResponse
	113, // 168: waverpc.DaemonService.ListTransactions:output_type -> waverpc.ListTransactionsResponse
	115, // 169: waverpc.DaemonService.Unroll:output_type -> waverpc.UnrollResponse
	120, // 170: waverpc.DaemonService.GetUnrollStatus:output_type -> waverpc.GetUnrollStatusResponse
	122, // 171: waverpc.DaemonService.ArmVHTLCRecovery:output_type -> waverpc.ArmVHTLCRecoveryResponse
	124, // 172: waverpc.DaemonService.EscalateVHTLCRecovery:output_type -> waverpc.EscalateVHTLCRecoveryResponse
	126, // 173: waverpc.DaemonService.CancelVHTLCRecovery:output_type -> waverpc.CancelVHTLCRecoveryResponse
	128, // 174: waverpc.DaemonService.GetVHTLCRecoveryStatus:output_type -> waverpc.GetVHTLCRecoveryStatusResponse
	130, // 175: waverpc.DaemonService.ListVHTLCRecoveries:output_type -> waverpc.ListVHTLCRecoveriesResponse
	133, // 176: waverpc.DaemonService.SignOutSwapHtlcAck:output_type -> waverpc.SignOutSwapHtlcAckResponse
	135, // 177: waverpc.DaemonService.SignCreditAccountAuthorization:output_type -> waverpc.SignCreditAccountAuthorizationResponse
	138, // 178: waverpc.MacaroonService.BakeMacaroon:output_type -> waverpc.BakeMacaroonResponse
	141, // 179: waverpc.MacaroonService.ListPermissions:output_type -> waverpc.ListPermissionsResponse
...
func file_daemon_proto_init() {
	...
	file_daemon_proto_msgTypes[36].OneofWrappers = []any{
		(*Output_Address)(nil),
		(*Output_Pubkey)(nil),
