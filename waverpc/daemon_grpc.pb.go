...
const (
	...
	DaemonService_RegisterReceiveChannelIntent_FullMethodName                   = "/waverpc.DaemonService/RegisterReceiveChannelIntent"
...
type DaemonServiceClient interface {
	...
	// OpenVirtualChannel promotes one existing VTXO into an LND channel whose
	...
	RegisterReceiveChannelIntent(ctx context.Context, in *RegisterReceiveChannelIntentRequest, opts ...grpc.CallOption) (*RegisterReceiveChannelIntentResponse, error)
...
func (c *daemonServiceClient) RegisterReceiveChannelIntent(ctx context.Context, in *RegisterReceiveChannelIntentRequest, opts ...grpc.CallOption) (*RegisterReceiveChannelIntentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterReceiveChannelIntentResponse)
	err := c.cc.Invoke(ctx, DaemonService_RegisterReceiveChannelIntent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DaemonServiceServer interface {
	...
	// RegisterReceiveChannelIntent requests an operator-funded virtual channel
	// in the next round. The client starts with no spendable channel balance.
	RegisterReceiveChannelIntent(context.Context, *RegisterReceiveChannelIntentRequest) (*RegisterReceiveChannelIntentResponse, error)
	// LeaveVTXOs queues one or more VTXOs for cooperative leave
	// (offboard) in the next round. Each VTXO is forfeited and the
	// forfeited amount (minus the quoted per-input operator fee)
	// lands as an on-chain output at the specified destination.
...
func (UnimplementedDaemonServiceServer) RegisterReceiveChannelIntent(context.Context, *RegisterReceiveChannelIntentRequest) (*RegisterReceiveChannelIntentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterReceiveChannelIntent not implemented")
}
...
func _DaemonService_RegisterReceiveChannelIntent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterReceiveChannelIntentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServiceServer).RegisterReceiveChannelIntent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonService_RegisterReceiveChannelIntent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServiceServer).RegisterReceiveChannelIntent(ctx, req.(*RegisterReceiveChannelIntentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DaemonService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RegisterReceiveChannelIntent",
			Handler:    _DaemonService_RegisterReceiveChannelIntent_Handler,
		},
		{
